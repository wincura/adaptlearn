 ...
 */
export declare class CfnJob extends cdk.CfnResource implements cdk.IInspectable, IJobRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     * The criteria that determine when and how a job abort takes place.
     */
    get abortConfig(): CfnJob.AbortConfigProperty | cdk.IResolvable | undefined;
    /**
     * The criteria that determine when and how a job abort takes place.
     */
    set abortConfig(value: CfnJob.AbortConfigProperty | cdk.IResolvable | undefined);
    /**
     * A short text description of the job.
     */
    get description(): string | undefined;
     ...
     * Parameters of an Amazon Web Services managed template that you can specify to create the job document.
     */
    get documentParameters(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * Parameters of an Amazon Web Services managed template that you can specify to create the job document.
     */
    set documentParameters(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * An S3 link, or S3 object URL, to the job document.
     */
    get documentSource(): string | undefined;
     ...
     * The configuration that determines how many retries are allowed for each failure type for a job.
     */
    get jobExecutionsRetryConfig(): cdk.IResolvable | CfnJob.JobExecutionsRetryConfigProperty | undefined;
    /**
     * The configuration that determines how many retries are allowed for each failure type for a job.
     */
    set jobExecutionsRetryConfig(value: cdk.IResolvable | CfnJob.JobExecutionsRetryConfigProperty | undefined);
    /**
     * Allows you to create a staged rollout of a job.
     */
    get jobExecutionsRolloutConfig(): cdk.IResolvable | CfnJob.JobExecutionsRolloutConfigProperty | undefined;
    /**
     * Allows you to create a staged rollout of a job.
     */
    set jobExecutionsRolloutConfig(value: cdk.IResolvable | CfnJob.JobExecutionsRolloutConfigProperty | undefined);
    /**
     * A job identifier which must be unique for your AWS account.
     */
    get jobId(): string;
     ...
     * The ARN of the job template used to create the job.
     */
    get jobTemplateArn(): string | undefined;
    /**
     * The ARN of the job template used to create the job.
     */
    set jobTemplateArn(value: string | undefined);
    /**
     * Configuration for pre-signed S3 URLs.
     */
    get presignedUrlConfig(): cdk.IResolvable | CfnJob.PresignedUrlConfigProperty | undefined;
    /**
     * Configuration for pre-signed S3 URLs.
     */
    set presignedUrlConfig(value: cdk.IResolvable | CfnJob.PresignedUrlConfigProperty | undefined);
    /**
     * Specifies the date and time that a job will begin the rollout of the job document to all devices in the target group.
     */
    get schedulingConfig(): cdk.IResolvable | CfnJob.SchedulingConfigProperty | undefined;
    /**
     * Specifies the date and time that a job will begin the rollout of the job document to all devices in the target group.
     */
    set schedulingConfig(value: cdk.IResolvable | CfnJob.SchedulingConfigProperty | undefined);
    /**
     * Metadata which can be used to manage the job.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     * Specifies whether the job will continue to run (CONTINUOUS), or will be complete after all those things specified as targets have completed the job (SNAPSHOT).
     */
    get targetSelection(): string | undefined;
    /**
     * Specifies whether the job will continue to run (CONTINUOUS), or will be complete after all those things specified as targets have completed the job (SNAPSHOT).
     */
    set targetSelection(value: string | undefined);
    /**
     * Specifies the amount of time each device has to finish its execution of the job.
     */
    get timeoutConfig(): cdk.IResolvable | CfnJob.TimeoutConfigProperty | undefined;
    /**
     * Specifies the amount of time each device has to finish its execution of the job.
     */
    set timeoutConfig(value: cdk.IResolvable | CfnJob.TimeoutConfigProperty | undefined);
    /**
...
export declare namespace CfnJob {
    ...
    interface JobExecutionsRolloutConfigProperty {
         ...
         */
        readonly exponentialRate?: CfnJob.ExponentialRolloutRateProperty | cdk.IResolvable;
        /**
         * The maximum number of things that will be notified of a pending job, per minute.
         *
         * This parameter allows you to create a staged rollout.
    ...
    interface ExponentialRolloutRateProperty {
         ...
         */
        readonly rateIncreaseCriteria: cdk.IResolvable | CfnJob.RateIncreaseCriteriaProperty;
    }
    /**
     * Allows you to define a criteria to initiate the increase in rate of rollout for a job.
     *
    ...
    interface AbortConfigProperty {
         ...
         */
        readonly criteriaList: Array<CfnJob.AbortCriteriaProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
     * The criteria that determine when and how a job abort takes place.
     *
    ...
    interface JobExecutionsRetryConfigProperty {
         ...
         */
        readonly criteriaList: Array<cdk.IResolvable | CfnJob.RetryCriteriaProperty> | cdk.IResolvable;
    }
    /**
     * The criteria that determines how many retries are allowed for each failure type for a job.
     *
    ...
    interface SchedulingConfigProperty {
         ...
         */
        readonly maintenanceWindows?: Array<cdk.IResolvable | CfnJob.MaintenanceWindowProperty> | cdk.IResolvable;
        /**
...
export interface CfnJobProps {
     ...
     */
    readonly abortConfig?: CfnJob.AbortConfigProperty | cdk.IResolvable;
    /**
     * A short text description of the job.
     *
     ...
     */
    readonly documentParameters?: cdk.IResolvable | Record<string, string>;
    /**
     * An S3 link, or S3 object URL, to the job document.
     *
     * The link is an Amazon S3 object URL and is required if you don't specify a value for document.
     ...
     */
    readonly jobExecutionsRetryConfig?: cdk.IResolvable | CfnJob.JobExecutionsRetryConfigProperty;
    /**
     * Allows you to create a staged rollout of a job.
     *
     ...
     */
    readonly jobExecutionsRolloutConfig?: cdk.IResolvable | CfnJob.JobExecutionsRolloutConfigProperty;
    /**
     * A job identifier which must be unique for your AWS account.
     *
     * We recommend using a UUID. Alpha-numeric characters, '-' and '_' are valid for use here.
     ...
     */
    readonly presignedUrlConfig?: cdk.IResolvable | CfnJob.PresignedUrlConfigProperty;
    /**
     * Specifies the date and time that a job will begin the rollout of the job document to all devices in the target group.
     *
     * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-iot-job.html#cfn-iot-job-schedulingconfig
     */
    readonly schedulingConfig?: cdk.IResolvable | CfnJob.SchedulingConfigProperty;
    /**
     * Metadata which can be used to manage the job.
     *
     ...
     */
    readonly timeoutConfig?: cdk.IResolvable | CfnJob.TimeoutConfigProperty;
}
/**
 ...
 */
export declare class CfnStream extends cdk.CfnResource implements cdk.IInspectable, IStreamRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     * The files to stream.
     */
    get files(): Array<cdk.IResolvable | CfnStream.StreamFileProperty> | cdk.IResolvable;
    /**
     * The files to stream.
     */
    set files(value: Array<cdk.IResolvable | CfnStream.StreamFileProperty> | cdk.IResolvable);
    /**
     * An IAM role that allows the IoT service principal to access your S3 files.
     */
    get roleArn(): string;
...
export declare namespace CfnStream {
    ...
    interface StreamFileProperty {
         ...
         */
        readonly s3Location?: cdk.IResolvable | CfnStream.S3LocationProperty;
    }
    /**
     * The location of the file in S3.
     *
...
export interface CfnStreamProps {
     ...
     */
    readonly files: Array<cdk.IResolvable | CfnStream.StreamFileProperty> | cdk.IResolvable;
    /**
     * An IAM role that allows the IoT service principal to access your S3 files.
     *
