...
export declare class CfnBot extends cdk.CfnResource implements cdk.IInspectable, IBotRef, cdk.ITaggableV2 {
     ...
     * The list of bot members in a network to be created.
     */
    get botMembers(): Array<CfnBot.BotMemberProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The list of bot members in a network to be created.
     */
    set botMembers(value: Array<CfnBot.BotMemberProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A list of tags to add to the bot.
     */
     ...
     * The type of a bot to create.
     */
    get botType(): string | undefined;
    /**
     * The type of a bot to create.
     */
    set botType(value: string | undefined);
    /**
     * By default, data stored by Amazon Lex is encrypted.
     */
...
export declare namespace CfnBot {
    ...
    interface BotMemberProperty {
         ...
         */
        readonly botMemberAliasId: string;
        /**
         ...
         */
        readonly botMemberAliasName: string;
        /**
         ...
         */
        readonly botMemberVersion: string;
    }
    /**
...
export interface CfnBotProps {
     ...
     */
    readonly botMembers?: Array<CfnBot.BotMemberProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A list of tags to add to the bot.
     *
