...
export declare class CfnWorkspace extends cdk.CfnResource implements cdk.IInspectable, IWorkspaceRef, cdk.ITaggableV2 {
     ...
     * The list of tags associated with the workspace.
     */
    get tags(): Array<CfnWorkspace.TagsItemsProperty> | undefined;
    /**
     * The list of tags associated with the workspace.
     */
    set tags(value: Array<CfnWorkspace.TagsItemsProperty> | undefined);
    /**
     * The configuration settings for an Amazon VPC that contains data sources for your Grafana workspace to connect to.
     */
...
export interface CfnWorkspaceProps {
     ...
     */
    readonly tags?: Array<CfnWorkspace.TagsItemsProperty>;
    /**
     * The configuration settings for an Amazon VPC that contains data sources for your Grafana workspace to connect to.
     *
     * > Connecting to a private VPC is not yet available in the Asia Pacific (Seoul) Region (ap-northeast-2).
