...
import { AnnotationStoreReference, ConfigurationReference, IAnnotationStoreRef, IConfigurationRef, IReferenceStoreRef, IRunCacheRef, IRunGroupRef, ISequenceStoreRef, IVariantStoreRef, IWorkflowRef, IWorkflowVersionRef, ReferenceStoreReference, RunCacheReference, RunGroupReference, SequenceStoreReference, VariantStoreReference, WorkflowReference, WorkflowVersionReference } from "../../interfaces/generated/aws-omics-interfaces.generated";
/**
 ...
 */
export declare class CfnRunCache extends cdk.CfnResource implements cdk.IInspectable, IRunCacheRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnRunCache from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnRunCache;
    /**
     * Checks whether the given object is a CfnRunCache
     */
    static isCfnRunCache(x: any): x is CfnRunCache;
    static arnForRunCache(resource: IRunCacheRef): string;
    /**
     ...
     */
    private _cacheBucketOwnerId?;
    /**
     * The S3 location for storing the cached task outputs.
     */
    private _cacheS3Location?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props?: CfnRunCacheProps);
    get runCacheRef(): RunCacheReference;
    /**
     * The default cache behavior for runs using this cache.
     */
    get cacheBehavior(): string | undefined;
    /**
     * The default cache behavior for runs using this cache.
     */
    set cacheBehavior(value: string | undefined);
    /**
     * The AWS account ID of the expected owner of the S3 bucket for the run cache.
     */
    get cacheBucketOwnerId(): string | undefined;
    /**
     * The AWS account ID of the expected owner of the S3 bucket for the run cache.
     */
    set cacheBucketOwnerId(value: string | undefined);
    /**
     * The S3 location for storing the cached task outputs.
     */
    get cacheS3Location(): string | undefined;
    /**
     * The S3 location for storing the cached task outputs.
     */
    set cacheS3Location(value: string | undefined);
    /**
     * A description of the run cache.
     */
    get description(): string | undefined;
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-omics-runcache.html
 */
export interface CfnRunCacheProps {
    /**
     * The default cache behavior for runs using this cache.
     *
...
export type { IRunCacheRef, RunCacheReference };
