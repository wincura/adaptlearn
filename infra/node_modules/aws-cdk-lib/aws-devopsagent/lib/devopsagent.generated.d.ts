...
import { AgentSpaceReference, AssetReference, AssociationReference, IAgentSpaceRef, IAssetRef, IAssociationRef, IPrivateConnectionRef, IServiceRef, ITriggerRef, PrivateConnectionReference, ServiceReference, TriggerReference } from "../../interfaces/generated/aws-devopsagent-interfaces.generated";
/**
 ...
 */
export declare class CfnAsset extends cdk.CfnResource implements cdk.IInspectable, IAssetRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     * Inline file list.
     */
    get files(): Array<CfnAsset.AssetFileProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * Inline file list.
     */
    set files(value: Array<CfnAsset.AssetFileProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Asset metadata document.
     */
    get metadata(): any | cdk.IResolvable | undefined;
    /**
     * Asset metadata document.
     */
    set metadata(value: any | cdk.IResolvable | undefined);
    /**
     * Base64-encoded zip bundle containing all files for the asset.
     */
...
export declare namespace CfnAsset {
    ...
    interface AssetFileProperty {
         ...
         */
        readonly metadata?: any | cdk.IResolvable;
        /**
...
export interface CfnAssetProps {
     ...
     */
    readonly files?: Array<CfnAsset.AssetFileProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Asset metadata document.
     *
...
export declare class CfnService extends cdk.CfnResource implements cdk.IInspectable, IServiceRef, cdk.ITaggableV2 {
     ...
     */
    private _exchangeUrlPrivateConnectionName?;
    /**
     * The ARN of the KMS key to use for encryption.
     */
    private _kmsKeyArn?;
     ...
     */
    private _privateConnectionName?;
    /**
     ...
     */
    private _targetUrlPrivateConnectionName?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * The name of the private connection to use for OAuth token exchange requests only.
     */
    get exchangeUrlPrivateConnectionName(): string | undefined;
    /**
     * The name of the private connection to use for OAuth token exchange requests only.
     */
    set exchangeUrlPrivateConnectionName(value: string | undefined);
    /**
     * The ARN of the KMS key to use for encryption.
     */
    get kmsKeyArn(): string | undefined;
     ...
     * The name of the private connection to use for VPC connectivity.
     */
    get privateConnectionName(): string | undefined;
    /**
     * The name of the private connection to use for VPC connectivity.
     */
    set privateConnectionName(value: string | undefined);
    /**
     * Service-specific configuration details - MCPServerSigV4 supports in-place updates;
     */
     ...
     * The name of the private connection to use for API calls (target URL) only.
     */
    get targetUrlPrivateConnectionName(): string | undefined;
    /**
     * The name of the private connection to use for API calls (target URL) only.
     */
    set targetUrlPrivateConnectionName(value: string | undefined);
    /**
 ...
 */
export declare class CfnTrigger extends cdk.CfnResource implements cdk.IInspectable, ITriggerRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     * The action to perform when the trigger fires.
     */
    get action(): any | cdk.IResolvable;
    /**
     * The action to perform when the trigger fires.
     */
    set action(value: any | cdk.IResolvable);
    /**
     * The unique identifier of the parent Agent Space.
     */
    get agentSpaceId(): string;
     ...
     * The condition that causes the trigger to fire.
     */
    get condition(): CfnTrigger.ConditionProperty | cdk.IResolvable;
    /**
     * The condition that causes the trigger to fire.
     */
    set condition(value: CfnTrigger.ConditionProperty | cdk.IResolvable);
    /**
     * The status of the trigger.
     */
...
export declare namespace CfnTrigger {
    ...
    interface ConditionProperty {
         ...
         */
        readonly schedule: cdk.IResolvable | CfnTrigger.ScheduleProperty;
    }
    /**
     * Schedule configuration for a time-based trigger.
     *
...
export interface CfnTriggerProps {
     ...
     */
    readonly action: any | cdk.IResolvable;
    /**
     * The unique identifier of the parent Agent Space.
     *
     ...
     */
    readonly condition: CfnTrigger.ConditionProperty | cdk.IResolvable;
    /**
     * The status of the trigger.
     *
