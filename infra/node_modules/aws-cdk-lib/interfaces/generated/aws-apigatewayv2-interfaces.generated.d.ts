 ...
 * @stability experimental
 */
export interface IPortalProductRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a PortalProduct resource.
     */
    readonly portalProductRef: PortalProductReference;
}
/**
 * A reference to a PortalProduct resource.
 *
 ...
 * @stability external
 */
export interface PortalProductReference {
    /**
