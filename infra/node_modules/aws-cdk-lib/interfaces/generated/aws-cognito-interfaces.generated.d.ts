 ...
 * @stability experimental
 */
export interface IUserPoolRegionalConfigurationAttachmentRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a UserPoolRegionalConfigurationAttachment resource.
     */
    readonly userPoolRegionalConfigurationAttachmentRef: UserPoolRegionalConfigurationAttachmentReference;
}
/**
 * A reference to a UserPoolRegionalConfigurationAttachment resource.
 *
 ...
 * @stability external
 */
export interface UserPoolRegionalConfigurationAttachmentReference {
    /**
 ...
 * @stability experimental
 */
export interface IUserPoolReplicaRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a UserPoolReplica resource.
     */
    readonly userPoolReplicaRef: UserPoolReplicaReference;
}
/**
 * A reference to a UserPoolReplica resource.
 *
 ...
 * @stability external
 */
export interface UserPoolReplicaReference {
    /**
