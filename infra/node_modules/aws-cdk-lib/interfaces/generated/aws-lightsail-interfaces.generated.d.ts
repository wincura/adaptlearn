 ...
 * @stability experimental
 */
export interface IContactMethodRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ContactMethod resource.
     */
    readonly contactMethodRef: ContactMethodReference;
}
/**
 * A reference to a ContactMethod resource.
 *
 ...
 * @stability external
 */
export interface ContactMethodReference {
    /**
     * The Arn of the ContactMethod resource.
     */
    readonly contactMethodArn: string;
}
/**
