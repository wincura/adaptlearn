 ...
 * @stability experimental
 */
export interface IPrefetchScheduleRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a PrefetchSchedule resource.
     */
    readonly prefetchScheduleRef: PrefetchScheduleReference;
}
/**
 * A reference to a PrefetchSchedule resource.
 *
 ...
 * @stability external
 */
export interface PrefetchScheduleReference {
    /**
     * The Arn of the PrefetchSchedule resource.
     */
    readonly prefetchScheduleArn: string;
}
