 ...
 * @stability experimental
 */
export interface IArchiveRuleRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ArchiveRule resource.
     */
    readonly archiveRuleRef: ArchiveRuleReference;
}
/**
 * A reference to a ArchiveRule resource.
 *
 ...
 * @stability external
 */
export interface ArchiveRuleReference {
    /**
     * The Arn of the ArchiveRule resource.
     */
    readonly archiveRuleArn: string;
}
