 ...
 * @stability experimental
 */
export interface ICloudConnectorRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a CloudConnector resource.
     */
    readonly cloudConnectorRef: CloudConnectorReference;
}
/**
 * A reference to a CloudConnector resource.
 *
 ...
 * @stability external
 */
export interface CloudConnectorReference {
    /**
 ...
 * @stability experimental
 */
export interface IServiceSettingRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ServiceSetting resource.
     */
    readonly serviceSettingRef: ServiceSettingReference;
}
/**
 * A reference to a ServiceSetting resource.
 *
 ...
 * @stability external
 */
export interface ServiceSettingReference {
    /**
     * The Arn of the ServiceSetting resource.
     */
    readonly serviceSettingArn: string;
}
