 ...
 * @stability experimental
 */
export interface IClusterSnapshotRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ClusterSnapshot resource.
     */
    readonly clusterSnapshotRef: ClusterSnapshotReference;
}
/**
 * A reference to a ClusterSnapshot resource.
 *
 ...
 * @stability external
 */
export interface ClusterSnapshotReference {
    /**
 ...
 * @stability experimental
 */
export interface IDBSnapshotRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a DBSnapshot resource.
     */
    readonly dbSnapshotRef: DBSnapshotReference;
}
/**
 * A reference to a DBSnapshot resource.
 *
 ...
 * @stability external
 */
export interface DBSnapshotReference {
    /**
