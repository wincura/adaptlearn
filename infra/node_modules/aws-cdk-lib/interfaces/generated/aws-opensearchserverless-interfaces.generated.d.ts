 ...
 * @stability experimental
 */
export interface ISecurityConfigRef extends constructs.IConstruct, IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ISecurityPolicyRef extends constructs.IConstruct, IEnvironmentAware {
    /**
 ...
 * @stability experimental
 */
export interface ICollectionGroupRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a CollectionGroup resource.
     */
    readonly collectionGroupRef: CollectionGroupReference;
}
/**
 * A reference to a CollectionGroup resource.
 *
 ...
 * @stability experimental
 */
export interface ICollectionIndexRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a CollectionIndex resource.
     */
    readonly collectionIndexRef: CollectionIndexReference;
}
/**
 * A reference to a CollectionIndex resource.
 *
 ...
 * @stability external
 */
export interface CollectionIndexReference {
    /**
