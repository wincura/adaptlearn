...
/**
 * Indicates that this resource can be referenced as a LogAlarm.
 *
 * @stability experimental
 */
export interface ILogAlarmRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a LogAlarm resource.
     */
    readonly logAlarmRef: LogAlarmReference;
}
/**
 * A reference to a LogAlarm resource.
 *
 ...
 * @stability external
 */
export interface LogAlarmReference {
    /**
 ...
 * @stability experimental
 */
export interface IOTelEnrichmentRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a OTelEnrichment resource.
     */
    readonly oTelEnrichmentRef: OTelEnrichmentReference;
}
/**
 * A reference to a OTelEnrichment resource.
 *
 ...
 * @stability external
 */
export interface OTelEnrichmentReference {
    /**
