 ...
 * @stability experimental
 */
export interface IPolicyStoreAliasRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a PolicyStoreAlias resource.
     */
    readonly policyStoreAliasRef: PolicyStoreAliasReference;
}
/**
 * A reference to a PolicyStoreAlias resource.
 *
 ...
 * @stability external
 */
export interface PolicyStoreAliasReference {
    /**
