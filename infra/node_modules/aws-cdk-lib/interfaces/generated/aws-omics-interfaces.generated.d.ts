 ...
 * @stability experimental
 */
export interface IRunCacheRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a RunCache resource.
     */
    readonly runCacheRef: RunCacheReference;
}
/**
 * A reference to a RunCache resource.
 *
 ...
 * @stability external
 */
export interface RunCacheReference {
    /**
     * The Arn of the RunCache resource.
     */
    readonly runCacheArn: string;
}
/**
