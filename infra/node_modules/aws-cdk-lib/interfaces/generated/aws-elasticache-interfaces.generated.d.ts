 ...
 * @stability experimental
 */
export interface IServerlessCacheSnapshotRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a ServerlessCacheSnapshot resource.
     */
    readonly serverlessCacheSnapshotRef: ServerlessCacheSnapshotReference;
}
/**
 * A reference to a ServerlessCacheSnapshot resource.
 *
 ...
 * @stability external
 */
export interface ServerlessCacheSnapshotReference {
    /**
     * The ARN of the ServerlessCacheSnapshot resource.
     */
    readonly serverlessCacheSnapshotArn: string;
}
