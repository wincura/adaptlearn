 ...
 * @stability experimental
 */
export interface ILinkRoutingRuleRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a LinkRoutingRule resource.
     */
    readonly linkRoutingRuleRef: LinkRoutingRuleReference;
}
/**
 * A reference to a LinkRoutingRule resource.
 *
 ...
 * @stability external
 */
export interface LinkRoutingRuleReference {
    /**
     * The Arn of the LinkRoutingRule resource.
     */
    readonly linkRoutingRuleArn: string;
}
/**
