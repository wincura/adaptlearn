 ...
 * @stability experimental
 */
export interface ICustomDetectionRuleAssociationRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a CustomDetectionRuleAssociation resource.
     */
    readonly customDetectionRuleAssociationRef: CustomDetectionRuleAssociationReference;
}
/**
 * A reference to a CustomDetectionRuleAssociation resource.
 *
 ...
 * @stability external
 */
export interface CustomDetectionRuleAssociationReference {
    /**
     ...
     */
    readonly customDetectionRuleAssociationArn: string;
}
/**
