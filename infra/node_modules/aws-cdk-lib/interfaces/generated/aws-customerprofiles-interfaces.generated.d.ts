 ...
 * @stability experimental
 */
export interface IDomainObjectTypeRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a DomainObjectType resource.
     */
    readonly domainObjectTypeRef: DomainObjectTypeReference;
}
/**
 * A reference to a DomainObjectType resource.
 *
 ...
 * @stability external
 */
export interface DomainObjectTypeReference {
    /**
