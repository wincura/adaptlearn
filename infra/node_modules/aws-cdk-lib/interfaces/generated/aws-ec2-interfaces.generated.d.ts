 ...
 * @stability experimental
 */
export interface IFpgaImageRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a FpgaImage resource.
     */
    readonly fpgaImageRef: FpgaImageReference;
}
/**
 * A reference to a FpgaImage resource.
 *
 ...
 * @stability external
 */
export interface FpgaImageReference {
    /**
     * The Arn of the FpgaImage resource.
     */
    readonly fpgaImageArn: string;
}
/**
 ...
 * @stability experimental
 */
export interface IIpamExternalResourceVerificationTokenRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a IpamExternalResourceVerificationToken resource.
     */
    readonly ipamExternalResourceVerificationTokenRef: IpamExternalResourceVerificationTokenReference;
}
/**
 * A reference to a IpamExternalResourceVerificationToken resource.
 *
 ...
 * @stability external
 */
export interface IpamExternalResourceVerificationTokenReference {
    /**
 ...
 * @stability experimental
 */
export interface ITransitGatewayPolicyTableEntryRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a TransitGatewayPolicyTableEntry resource.
     */
    readonly transitGatewayPolicyTableEntryRef: TransitGatewayPolicyTableEntryReference;
}
/**
 * A reference to a TransitGatewayPolicyTableEntry resource.
 *
 ...
 * @stability external
 */
export interface TransitGatewayPolicyTableEntryReference {
    /**
