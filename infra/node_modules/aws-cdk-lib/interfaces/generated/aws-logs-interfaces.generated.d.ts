 ...
 * @stability experimental
 */
export interface IStorageTierPolicyRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a StorageTierPolicy resource.
     */
    readonly storageTierPolicyRef: StorageTierPolicyReference;
}
/**
 * A reference to a StorageTierPolicy resource.
 *
 ...
 * @stability external
 */
export interface StorageTierPolicyReference {
    /**
