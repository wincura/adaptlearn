 ...
 * @stability experimental
 */
export interface ISnapshotScheduleRef extends constructs.IConstruct, IEnvironmentAware {
    /**
     * A reference to a SnapshotSchedule resource.
     */
    readonly snapshotScheduleRef: SnapshotScheduleReference;
}
/**
 * A reference to a SnapshotSchedule resource.
 *
 ...
 * @stability external
 */
export interface SnapshotScheduleReference {
    /**
     * The Arn of the SnapshotSchedule resource.
     */
    readonly snapshotScheduleArn: string;
}
