...
export declare class CfnConnection extends cdk.CfnResource implements cdk.IInspectable, IConnectionRef {
     ...
     * The configurations of the connection.
     */
    get configurations(): Array<CfnConnection.ConnectionConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The configurations of the connection.
     */
    set configurations(value: Array<CfnConnection.ConnectionConfigurationProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * Connection description.
     */
...
export declare namespace CfnConnection {
    ...
    interface ConnectionPropertiesInputProperty {
         ...
         */
        readonly lakehouseProperties?: cdk.IResolvable | CfnConnection.LakehousePropertiesInputProperty;
        /**
...
export interface CfnConnectionProps {
     ...
     */
    readonly configurations?: Array<CfnConnection.ConnectionConfigurationProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * Connection description.
     *
...
export declare class CfnDomain extends cdk.CfnResource implements cdk.IInspectable, IDomainRef, cdk.ITaggableV2 {
     ...
     * The domain execution role that is created when an Amazon DataZone domain is created.
     */
    get domainExecutionRole(): string | undefined;
    /**
     * The domain execution role that is created when an Amazon DataZone domain is created.
     */
    set domainExecutionRole(value: string | undefined);
    /**
     * The domain version.
     */
...
export declare class CfnGroupProfile extends cdk.CfnResource implements cdk.IInspectable, IGroupProfileRef {
     ...
     * The type of the group.
     */
    set groupType(value: string | undefined);
    /**
     * The ARN of the role principal for the group profile.
     */
    get rolePrincipalArn(): string | undefined;
    /**
     * The ARN of the role principal for the group profile.
     */
    set rolePrincipalArn(value: string | undefined);
    /**
     * The status of a group profile.
     */
    get status(): string | undefined;
     ...
     */
    get attrRolePrincipalId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnProject extends cdk.CfnResource implements cdk.IInspectable, IProjectRef {
     ...
     */
    private _membershipAssignments?;
    /**
     ...
     */
    private _projectCategory?;
    /**
     * The project execution role ARN.
     */
    private _projectExecutionRole?;
    /**
     ...
     * The project membership assignments.
     */
    get membershipAssignments(): Array<cdk.IResolvable | CfnProject.ProjectMembershipAssignmentProperty> | cdk.IResolvable | undefined;
    /**
     * The project membership assignments.
     */
    set membershipAssignments(value: Array<cdk.IResolvable | CfnProject.ProjectMembershipAssignmentProperty> | cdk.IResolvable | undefined);
    /**
     * The name of a project.
     */
    get name(): string;
     ...
     * The project category.
     */
    get projectCategory(): string | undefined;
    /**
     * The project category.
     */
    set projectCategory(value: string | undefined);
    /**
     * The project execution role ARN.
     */
    get projectExecutionRole(): string | undefined;
    /**
     * The project execution role ARN.
     */
    set projectExecutionRole(value: string | undefined);
    /**
     * The ID of the project profile.
     */
...
export declare namespace CfnProject {
    ...
    interface ProjectMembershipAssignmentProperty {
         ...
         */
        readonly member: cdk.IResolvable | CfnProject.MemberProperty;
    }
    /**
     * The member of the project.
     *
...
export interface CfnProjectProps {
     ...
     */
    readonly membershipAssignments?: Array<cdk.IResolvable | CfnProject.ProjectMembershipAssignmentProperty> | cdk.IResolvable;
    /**
     * The name of a project.
     *
