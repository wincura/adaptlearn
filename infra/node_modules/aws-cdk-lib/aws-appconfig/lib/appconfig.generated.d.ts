...
import { ApplicationReference, ConfigurationProfileReference, DeploymentReference, DeploymentStrategyReference, EnvironmentReference, ExperimentDefinitionReference, ExtensionAssociationReference, ExtensionReference, HostedConfigurationVersionReference, IApplicationRef, IConfigurationProfileRef, IDeploymentRef, IDeploymentStrategyRef, IEnvironmentRef, IExperimentDefinitionRef, IExtensionAssociationRef, IExtensionRef, IHostedConfigurationVersionRef } from "../../interfaces/generated/aws-appconfig-interfaces.generated";
 ...
 */
export declare class CfnExperimentDefinition extends cdk.CfnResource implements cdk.IInspectable, IExperimentDefinitionRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnExperimentDefinition from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnExperimentDefinition;
    /**
     * Checks whether the given object is a CfnExperimentDefinition
     */
    static isCfnExperimentDefinition(x: any): x is CfnExperimentDefinition;
    /**
     ...
     */
    private _audienceDescription?;
    /**
     * Rule expression defining the experiment audience.
     */
    private _audienceRule;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _configurationProfileIdentifier;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnExperimentDefinitionProps);
    get experimentDefinitionRef(): ExperimentDefinitionReference;
    /**
     * The application ID, name, or ARN.
     */
     ...
     * Human-readable description of the audience.
     */
    get audienceDescription(): string | undefined;
    /**
     * Human-readable description of the audience.
     */
    set audienceDescription(value: string | undefined);
    /**
     * Rule expression defining the experiment audience.
     */
    get audienceRule(): string;
    /**
     * Rule expression defining the experiment audience.
     */
    set audienceRule(value: string);
    /**
     * The configuration profile ID, name, or ARN.
     */
    get configurationProfileIdentifier(): string;
    /**
     * The configuration profile ID, name, or ARN.
     */
    set configurationProfileIdentifier(value: string);
    /**
     * A treatment variant with weight and flag value.
     */
    get control(): cdk.IResolvable | CfnExperimentDefinition.TreatmentProperty;
    /**
     * A treatment variant with weight and flag value.
     */
    set control(value: cdk.IResolvable | CfnExperimentDefinition.TreatmentProperty);
    /**
     * The environment ID, name, or ARN.
     */
     ...
     * The hypothesis of the experiment.
     */
    set hypothesis(value: string | undefined);
    /**
     * Criteria for launching the experiment.
     */
    get launchCriteria(): string | undefined;
    /**
     * Criteria for launching the experiment.
     */
    set launchCriteria(value: string | undefined);
    /**
     * A name for the experiment definition.
     */
    get name(): string;
     ...
     * Treatment variants (1-5).
     */
    get treatments(): Array<cdk.IResolvable | CfnExperimentDefinition.TreatmentProperty> | cdk.IResolvable;
    /**
     * Treatment variants (1-5).
     */
    set treatments(value: Array<cdk.IResolvable | CfnExperimentDefinition.TreatmentProperty> | cdk.IResolvable);
    /**
...
export declare namespace CfnExperimentDefinition {
    /**
     * A treatment variant with weight and flag value.
     *
    ...
    interface TreatmentProperty {
         ...
         */
        readonly attributeValues?: cdk.IResolvable | Record<string, CfnExperimentDefinition.AttributeValueProperty | cdk.IResolvable>;
        /**
    ...
    interface AttributeValueProperty {
         ...
         */
        readonly numberArray?: Array<number> | cdk.IResolvable;
        /**
         * A numeric value.
         *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-appconfig-experimentdefinition.html
 */
export interface CfnExperimentDefinitionProps {
    /**
     * The application ID, name, or ARN.
     *
     ...
     */
    readonly control: cdk.IResolvable | CfnExperimentDefinition.TreatmentProperty;
    /**
     * The environment ID, name, or ARN.
     *
     ...
     */
    readonly treatments: Array<cdk.IResolvable | CfnExperimentDefinition.TreatmentProperty> | cdk.IResolvable;
}
...
export type { IExperimentDefinitionRef, ExperimentDefinitionReference };
