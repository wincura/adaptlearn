...
import { ConfigurationSetReference, IConfigurationSetRef, IOptOutListRef, IPhoneNumberRef, IPoolRef, IProtectConfigurationRef, IRegistrationRef, IResourcePolicyRef, ISenderIdRef, OptOutListReference, PhoneNumberReference, PoolReference, ProtectConfigurationReference, RegistrationReference, ResourcePolicyReference, SenderIdReference } from "../../interfaces/generated/aws-smsvoice-interfaces.generated";
/**
 ...
 */
export declare class CfnRegistration extends cdk.CfnResource implements cdk.IInspectable, IRegistrationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnRegistration from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnRegistration;
    /**
     * Checks whether the given object is a CfnRegistration
     */
    static isCfnRegistration(x: any): x is CfnRegistration;
    static arnForRegistration(resource: IRegistrationRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnRegistrationProps);
    get registrationRef(): RegistrationReference;
    /**
     * The type of registration form to create.
     */
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-smsvoice-registration.html
 */
export interface CfnRegistrationProps {
    /**
     * The type of registration form to create.
     *
...
export type { IRegistrationRef, RegistrationReference };
