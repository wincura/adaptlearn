...
import { IdentitySourceReference, IIdentitySourceRef, IPolicyRef, IPolicyStoreAliasRef, IPolicyStoreRef, IPolicyTemplateRef, PolicyReference, PolicyStoreAliasReference, PolicyStoreReference, PolicyTemplateReference } from "../../interfaces/generated/aws-verifiedpermissions-interfaces.generated";
/**
 ...
 */
export declare class CfnPolicyStoreAlias extends cdk.CfnResource implements cdk.IInspectable, IPolicyStoreAliasRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnPolicyStoreAlias from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnPolicyStoreAlias;
    /**
     * Checks whether the given object is a CfnPolicyStoreAlias
     */
    static isCfnPolicyStoreAlias(x: any): x is CfnPolicyStoreAlias;
    /**
     * Creates a new IPolicyStoreAliasRef from a aliasName
     */
    static fromAliasName(scope: constructs.Construct, id: string, aliasName: string): IPolicyStoreAliasRef;
    static arnForPolicyStoreAlias(resource: IPolicyStoreAliasRef): string;
    private _aliasName;
    private _policyStoreId;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnPolicyStoreAliasProps);
    get policyStoreAliasRef(): PolicyStoreAliasReference;
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-verifiedpermissions-policystorealias.html
 */
export interface CfnPolicyStoreAliasProps {
    /**
...
export type { IPolicyStoreAliasRef, PolicyStoreAliasReference };
