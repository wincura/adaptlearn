...
import { BackupReference, GlobalTableReference, IBackupRef, IGlobalTableRef, ITableRef, TableReference } from "../../interfaces/generated/aws-dynamodb-interfaces.generated";
/**
 ...
 */
export declare class CfnBackup extends cdk.CfnResource implements cdk.IInspectable, IBackupRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnBackup from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnBackup;
    /**
     * Checks whether the given object is a CfnBackup
     */
    static isCfnBackup(x: any): x is CfnBackup;
    static arnForBackup(resource: IBackupRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnBackupProps);
    get backupRef(): BackupReference;
    /**
     * The name for the backup.
     */
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-dynamodb-backup.html
 */
export interface CfnBackupProps {
    /**
     * The name for the backup.
     *
...
export type { IBackupRef, BackupReference };
