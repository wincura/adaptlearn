 ...
 *
 * @cloudformationResource AWS::Bedrock::Session
 * @stability external
...
export declare class CfnSession extends cdk.CfnResource implements cdk.IInspectable, ISessionRef, cdk.ITaggableV2 {
     ...
     * A map of key-value pairs containing attributes to be persisted across the session.
     */
    get sessionMetadata(): cdk.IResolvable | Record<string, string> | undefined;
    /**
     * A map of key-value pairs containing attributes to be persisted across the session.
     */
    set sessionMetadata(value: cdk.IResolvable | Record<string, string> | undefined);
    /**
     * A list of tags associated with the session.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     *
     * @cloudformationAttribute SessionArn
     */
    get attrSessionArn(): string;
    /**
     ...
     *
     * @cloudformationAttribute SessionStatus
     */
    get attrSessionStatus(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export interface CfnSessionProps {
     ...
     */
    readonly sessionMetadata?: cdk.IResolvable | Record<string, string>;
    /**
     * A list of tags associated with the session.
     *
