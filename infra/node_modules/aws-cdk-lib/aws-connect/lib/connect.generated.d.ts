 ...
 */
export declare class CfnMetric extends cdk.CfnResource implements cdk.IInspectable, IMetricRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnMetric from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnMetric;
    /**
     * Checks whether the given object is a CfnMetric
     */
    static isCfnMetric(x: any): x is CfnMetric;
    static arnForMetric(resource: IMetricRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _positiveTrendIndicator?;
    /**
     ...
     * The calculation configuration for the metric.
     */
    get metricCalculation(): cdk.IResolvable | CfnMetric.MetricCalculationProperty | undefined;
    /**
     * The calculation configuration for the metric.
     */
    set metricCalculation(value: cdk.IResolvable | CfnMetric.MetricCalculationProperty | undefined);
    /**
     * The name of the custom metric.
     */
    get name(): string | undefined;
     ...
     * Indicates how to classify a positive trend in metric data on the UI.
     */
    get positiveTrendIndicator(): string | undefined;
    /**
     * Indicates how to classify a positive trend in metric data on the UI.
     */
    set positiveTrendIndicator(value: string | undefined);
    /**
     * The status of the custom metric.
     */
    get status(): string | undefined;
     ...
     */
    get attrCreatedUser(): cdk.IResolvable;
    /**
     ...
     */
    get attrLastModifiedUser(): cdk.IResolvable;
    /**
     ...
     */
    get attrPrimaryEventSource(): string;
    /**
     ...
     */
    get attrSupportsPreaggregateCalculation(): cdk.IResolvable;
    /**
...
export declare namespace CfnMetric {
    /**
     * The calculation configuration for the metric.
     *
     * @struct
     ...
     */
    interface MetricCalculationProperty {
        /**
         ...
         */
        readonly calculationComponents: Array<CfnMetric.CalculationComponentProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface CalculationComponentProperty {
         ...
         */
        readonly metricFilters?: Array<cdk.IResolvable | CfnMetric.MetricFilterProperty> | cdk.IResolvable;
        /**
    ...
    interface MetricFilterProperty {
         ...
         */
        readonly booleanCondition?: cdk.IResolvable | CfnMetric.MetricFilterBooleanConditionProperty;
        /**
         ...
         */
        readonly negate?: boolean | cdk.IResolvable;
        /**
         ...
         */
        readonly numberCondition?: cdk.IResolvable | CfnMetric.MetricFilterNumberConditionProperty;
        /**
         ...
         */
        readonly stringCondition?: cdk.IResolvable | CfnMetric.MetricFilterStringConditionProperty;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface MetricFilterNumberConditionProperty {
        /**
     ...
     */
    interface MetricFilterStringConditionProperty {
        /**
     ...
     */
    interface MetricFilterBooleanConditionProperty {
        /**
    ...
    interface CreatedByInfoProperty {
         ...
         */
        readonly awsIdentityArn?: string;
        /**
         ...
         */
        readonly connectUserArn?: string;
    }
    /**
     * @struct
     * @stability external
     ...
     */
    interface AvailableFilterProperty {
        /**
...
export interface CfnMetricProps {
     ...
     */
    readonly metricCalculation?: cdk.IResolvable | CfnMetric.MetricCalculationProperty;
    /**
     * The name of the custom metric.
     *
...
export type { IMetricRef, MetricReference };
