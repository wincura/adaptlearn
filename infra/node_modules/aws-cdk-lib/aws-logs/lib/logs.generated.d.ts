 ...
 */
export declare class CfnStorageTierPolicy extends cdk.CfnResource implements cdk.IInspectable, IStorageTierPolicyRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnStorageTierPolicy from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnStorageTierPolicy;
    /**
     * Checks whether the given object is a CfnStorageTierPolicy
     */
    static isCfnStorageTierPolicy(x: any): x is CfnStorageTierPolicy;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnStorageTierPolicyProps);
    get storageTierPolicyRef(): StorageTierPolicyReference;
    /**
     * The storage tier to apply.
     */
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-logs-storagetierpolicy.html
 */
export interface CfnStorageTierPolicyProps {
    /**
     * The storage tier to apply.
     *
...
export type { IStorageTierPolicyRef, StorageTierPolicyReference };
