 ...
 */
export declare function validateManagedPasswordCredentials(scope: Construct, credentials?: Credentials): void;
/**
 * Validates that snapshot credentials used with manageMasterUserPassword don't include unsupported properties.
 * When RDS manages the master password, only 'username' and 'encryptionKey' are allowed.
 */
export declare function validateManagedPasswordSnapshotCredentials(scope: Construct, snapshotCredentials?: SnapshotCredentials): void;
/**
