...
import { ClusterSnapshotReference, CustomDBEngineVersionReference, DBClusterParameterGroupReference, DBClusterReference, DBInstanceReference, DBParameterGroupReference, DBProxyEndpointReference, DBProxyReference, DBProxyTargetGroupReference, DBSecurityGroupIngressReference, DBSecurityGroupReference, DBShardGroupReference, DBSnapshotReference, DBSubnetGroupReference, EventSubscriptionReference, GlobalClusterReference, IClusterSnapshotRef, ICustomDBEngineVersionRef, IDBClusterParameterGroupRef, IDBClusterRef, IDBInstanceRef, IDBParameterGroupRef, IDBProxyEndpointRef, IDBProxyRef, IDBProxyTargetGroupRef, IDBSecurityGroupIngressRef, IDBSecurityGroupRef, IDBShardGroupRef, IDBSnapshotRef, IDBSubnetGroupRef, IEventSubscriptionRef, IGlobalClusterRef, IIntegrationRef, IntegrationReference, IOptionGroupRef, OptionGroupReference } from "../../interfaces/generated/aws-rds-interfaces.generated";
...
export declare class CfnDBParameterGroup extends cdk.CfnResource implements cdk.IInspectable, IDBParameterGroupRef, cdk.ITaggable {
     ...
     */
    static fromDBParameterGroupArn(scope: constructs.Construct, id: string, arn: string): IDBParameterGroupRef;
    /**
     ...
     */
    get attrDbParameterGroupArn(): string;
    /**
     * The name of the DB parameter group.
     *
 ...
 */
export declare class CfnClusterSnapshot extends cdk.CfnResource implements cdk.IInspectable, IClusterSnapshotRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnClusterSnapshot from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnClusterSnapshot;
    /**
     * Checks whether the given object is a CfnClusterSnapshot
     */
    static isCfnClusterSnapshot(x: any): x is CfnClusterSnapshot;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnClusterSnapshotProps);
    get clusterSnapshotRef(): ClusterSnapshotReference;
    /**
     * The identifier of the DB cluster to create a snapshot for.
     */
     ...
     */
    get attrAllocatedStorage(): number;
    /**
     ...
     */
    get attrAvailabilityZones(): Array<string>;
    /**
     * The time when the DB cluster was created, in Universal Coordinated Time (UTC).
     *
     * @cloudformationAttribute ClusterCreateTime
     */
    get attrClusterCreateTime(): string;
    /**
     ...
     */
    get attrDbClusterSnapshotArn(): string;
    /**
     ...
     */
    get attrSnapshotCreateTime(): string;
    /**
     * The type of the DB cluster snapshot.
     *
     * @cloudformationAttribute SnapshotType
     */
    get attrSnapshotType(): string;
    /**
     ...
     */
    get attrStorageEncrypted(): cdk.IResolvable;
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-clustersnapshot.html
 */
export interface CfnClusterSnapshotProps {
    /**
     * The identifier of the DB cluster to create a snapshot for.
     *
 ...
 */
export declare class CfnDBSnapshot extends cdk.CfnResource implements cdk.IInspectable, IDBSnapshotRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnDBSnapshot from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnDBSnapshot;
    /**
     * Checks whether the given object is a CfnDBSnapshot
     */
    static isCfnDBSnapshot(x: any): x is CfnDBSnapshot;
    static arnForDBSnapshot(resource: IDBSnapshotRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnDBSnapshotProps);
    get dbSnapshotRef(): DBSnapshotReference;
    /**
     * The identifier of the DB instance that you want to create the snapshot of.
     */
     ...
     */
    get attrOptionGroupName(): string;
    /**
     ...
     */
    get attrOriginalSnapshotCreateTime(): string;
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-rds-dbsnapshot.html
 */
export interface CfnDBSnapshotProps {
    /**
     * The identifier of the DB instance that you want to create the snapshot of.
     *
...
export type { IClusterSnapshotRef, ClusterSnapshotReference };
export type { IDBShardGroupRef, DBShardGroupReference };
export type { IDBSnapshotRef, DBSnapshotReference };
