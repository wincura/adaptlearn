...
import { DataSourceReference, FaqReference, IDataSourceRef, IFaqRef, IIndexRef, IndexReference, IQuerySuggestionsBlockListRef, IThesaurusRef, QuerySuggestionsBlockListReference, ThesaurusReference } from "../../interfaces/generated/aws-kendra-interfaces.generated";
/**
 ...
 */
export declare class CfnQuerySuggestionsBlockList extends cdk.CfnResource implements cdk.IInspectable, IQuerySuggestionsBlockListRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnQuerySuggestionsBlockList from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnQuerySuggestionsBlockList;
    /**
     * Checks whether the given object is a CfnQuerySuggestionsBlockList
     */
    static isCfnQuerySuggestionsBlockList(x: any): x is CfnQuerySuggestionsBlockList;
    static arnForQuerySuggestionsBlockList(resource: IQuerySuggestionsBlockListRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnQuerySuggestionsBlockListProps);
    get querySuggestionsBlockListRef(): QuerySuggestionsBlockListReference;
    /**
     * A description for the block list.
     */
    get description(): string | undefined;
     ...
     * Information required to find a specific file in an Amazon S3 bucket.
     */
    get sourceS3Path(): cdk.IResolvable | CfnQuerySuggestionsBlockList.S3PathProperty;
    /**
     * Information required to find a specific file in an Amazon S3 bucket.
     */
    set sourceS3Path(value: cdk.IResolvable | CfnQuerySuggestionsBlockList.S3PathProperty);
    /**
     * A list of key-value pairs that identify or categorize the block list.
     */
...
export declare namespace CfnQuerySuggestionsBlockList {
    /**
     * Information required to find a specific file in an Amazon S3 bucket.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kendra-querysuggestionsblocklist.html
 */
export interface CfnQuerySuggestionsBlockListProps {
    /**
     * A description for the block list.
     *
     ...
     */
    readonly sourceS3Path: cdk.IResolvable | CfnQuerySuggestionsBlockList.S3PathProperty;
    /**
     * A list of key-value pairs that identify or categorize the block list.
     *
 ...
 */
export declare class CfnThesaurus extends cdk.CfnResource implements cdk.IInspectable, IThesaurusRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnThesaurus from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnThesaurus;
    /**
     * Checks whether the given object is a CfnThesaurus
     */
    static isCfnThesaurus(x: any): x is CfnThesaurus;
    static arnForThesaurus(resource: IThesaurusRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnThesaurusProps);
    get thesaurusRef(): ThesaurusReference;
    /**
     * A description for the thesaurus.
     */
    get description(): string | undefined;
     ...
     * Information required to find a specific file in an Amazon S3 bucket.
     */
    get sourceS3Path(): cdk.IResolvable | CfnThesaurus.S3PathProperty;
    /**
     * Information required to find a specific file in an Amazon S3 bucket.
     */
    set sourceS3Path(value: cdk.IResolvable | CfnThesaurus.S3PathProperty);
    /**
     * A list of key-value pairs that identify or categorize the thesaurus.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
...
export declare namespace CfnThesaurus {
    /**
     * Information required to find a specific file in an Amazon S3 bucket.
     *
     * @struct
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-kendra-thesaurus.html
 */
export interface CfnThesaurusProps {
    /**
     * A description for the thesaurus.
     *
     ...
     */
    readonly sourceS3Path: cdk.IResolvable | CfnThesaurus.S3PathProperty;
    /**
     * A list of key-value pairs that identify or categorize the thesaurus.
     *
...
export type { IQuerySuggestionsBlockListRef, QuerySuggestionsBlockListReference };
export type { IThesaurusRef, ThesaurusReference };
