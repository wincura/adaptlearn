 ...
 *
 * @cloudformationResource AWS::AppSync::Type
 * @stability external
...
export declare class CfnType extends cdk.CfnResource implements cdk.IInspectable, ITypeRef {
    ...
    static arnForType(resource: ITypeRef): string;
    /**
     * The API ID.
     */
    private _apiId;
