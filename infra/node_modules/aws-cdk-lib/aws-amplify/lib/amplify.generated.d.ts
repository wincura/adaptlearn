...
import { AppReference, BranchReference, DomainReference, IAppRef, IBranchRef, IDomainRef, IWebhookRef, WebhookReference } from "../../interfaces/generated/aws-amplify-interfaces.generated";
/**
...
export declare class CfnWebhook extends cdk.CfnResource implements cdk.IInspectable, IWebhookRef, cdk.ITaggableV2 {
     ...
     */
    get attrWebhookId(): string;
    /**
     * The URL of the webhook.
     *
     * @cloudformationAttribute WebhookUrl
     */
    get attrWebhookUrl(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
