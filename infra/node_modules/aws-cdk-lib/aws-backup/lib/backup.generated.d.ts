...
import { BackupPlanReference, BackupSelectionReference, BackupVaultReference, FrameworkReference, IBackupPlanRef, IBackupSelectionRef, IBackupVaultRef, IFrameworkRef, ILegalHoldRef, ILogicallyAirGappedBackupVaultRef, IReportPlanRef, IRestoreTestingPlanRef, IRestoreTestingSelectionRef, ITieringConfigurationRef, LegalHoldReference, LogicallyAirGappedBackupVaultReference, ReportPlanReference, RestoreTestingPlanReference, RestoreTestingSelectionReference, TieringConfigurationReference } from "../../interfaces/generated/aws-backup-interfaces.generated";
 ...
 */
export declare class CfnLegalHold extends cdk.CfnResource implements cdk.IInspectable, ILegalHoldRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnLegalHold from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnLegalHold;
    /**
     * Checks whether the given object is a CfnLegalHold
     */
    static isCfnLegalHold(x: any): x is CfnLegalHold;
    static arnForLegalHold(resource: ILegalHoldRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnLegalHoldProps);
    get legalHoldRef(): LegalHoldReference;
    /**
     * The description of the legal hold.
     */
     ...
     * The criteria to assign a set of resources, such as resource types or backup vaults.
     */
    get recoveryPointSelection(): cdk.IResolvable | CfnLegalHold.RecoveryPointSelectionProperty;
    /**
     * The criteria to assign a set of resources, such as resource types or backup vaults.
     */
    set recoveryPointSelection(value: cdk.IResolvable | CfnLegalHold.RecoveryPointSelectionProperty);
    /**
     * Optional tags to include.
     */
    get tags(): Array<CfnLegalHold.TagsItemsProperty> | undefined;
    /**
     * Optional tags to include.
     */
    set tags(value: Array<CfnLegalHold.TagsItemsProperty> | undefined);
    /**
     * The title of the legal hold.
     */
    get title(): string;
...
export declare namespace CfnLegalHold {
    /**
     * The criteria to assign a set of resources, such as resource types or backup vaults.
     *
     * @struct
    ...
    interface RecoveryPointSelectionProperty {
         ...
         */
        readonly dateRange?: CfnLegalHold.DateRangeProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly resourceIdentifiers?: Array<string>;
        /**
         ...
         */
        readonly vaultNames?: Array<string>;
    }
    /**
     * A date range for filtering recovery points.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-backup-legalhold.html
 */
export interface CfnLegalHoldProps {
    /**
     * The description of the legal hold.
     *
     ...
     */
    readonly recoveryPointSelection: cdk.IResolvable | CfnLegalHold.RecoveryPointSelectionProperty;
    /**
     * Optional tags to include.
     *
     ...
     */
    readonly tags?: Array<CfnLegalHold.TagsItemsProperty>;
    /**
     * The title of the legal hold.
     *
...
export type { ILegalHoldRef, LegalHoldReference };
