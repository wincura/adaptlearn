...
import { AssociationReference, CloudConnectorReference, DocumentReference, IAssociationRef, ICloudConnectorRef, IDocumentRef, IMaintenanceWindowRef, IMaintenanceWindowTargetRef, IMaintenanceWindowTaskRef, IOpsItemRef, IParameterRef, IPatchBaselineRef, IResourceDataSyncRef, IResourcePolicyRef, IServiceSettingRef, MaintenanceWindowReference, MaintenanceWindowTargetReference, MaintenanceWindowTaskReference, OpsItemReference, ParameterReference, PatchBaselineReference, ResourceDataSyncReference, ResourcePolicyReference, ServiceSettingReference } from "../../interfaces/generated/aws-ssm-interfaces.generated";
/**
 ...
 */
export declare class CfnCloudConnector extends cdk.CfnResource implements cdk.IInspectable, ICloudConnectorRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnCloudConnector from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnCloudConnector;
    /**
     * Checks whether the given object is a CfnCloudConnector
     */
    static isCfnCloudConnector(x: any): x is CfnCloudConnector;
    static arnForCloudConnector(resource: ICloudConnectorRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnCloudConnectorProps);
    get cloudConnectorRef(): CloudConnectorReference;
    /**
     * The ARN of the AWS Config connector.
     */
    get configConnectorArn(): string;
    /**
     * The ARN of the AWS Config connector.
     */
    set configConnectorArn(value: string);
    /**
     * The configuration for the cloud connector.
     */
    get configuration(): CfnCloudConnector.CloudConnectorConfigurationProperty | cdk.IResolvable;
    /**
     * The configuration for the cloud connector.
     */
    set configuration(value: CfnCloudConnector.CloudConnectorConfigurationProperty | cdk.IResolvable);
    /**
     * The description of the cloud connector.
     */
    get description(): string | undefined;
...
export declare namespace CfnCloudConnector {
    /**
     * The configuration for the cloud connector.
     *
    ...
    interface CloudConnectorConfigurationProperty {
         ...
         */
        readonly azureConfiguration: CfnCloudConnector.AzureConfigurationProperty | cdk.IResolvable;
    }
    /**
     * Configuration for connecting to Azure.
     *
    ...
    interface AzureConfigurationProperty {
         ...
         */
        readonly targets?: CfnCloudConnector.ConfigurationTargetsProperty | cdk.IResolvable;
        /**
    ...
    interface ConfigurationTargetsProperty {
         ...
         */
        readonly subscriptions: Array<CfnCloudConnector.AzureSubscriptionProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ssm-cloudconnector.html
 */
export interface CfnCloudConnectorProps {
    /**
     * The ARN of the AWS Config connector.
     *
     ...
     */
    readonly configuration: CfnCloudConnector.CloudConnectorConfigurationProperty | cdk.IResolvable;
    /**
     * The description of the cloud connector.
     *
 ...
 */
export declare class CfnServiceSetting extends cdk.CfnResource implements cdk.IInspectable, IServiceSettingRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnServiceSetting from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnServiceSetting;
    /**
     * Checks whether the given object is a CfnServiceSetting
     */
    static isCfnServiceSetting(x: any): x is CfnServiceSetting;
    static arnForServiceSetting(resource: IServiceSettingRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnServiceSettingProps);
    get serviceSettingRef(): ServiceSettingReference;
    /**
     * The ID of the service setting, such as /ssm/parameter-store/high-throughput-enabled.
     */
     ...
     */
    get attrLastModifiedUser(): string;
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-ssm-servicesetting.html
 */
export interface CfnServiceSettingProps {
    /**
     * The ID of the service setting, such as /ssm/parameter-store/high-throughput-enabled.
     *
...
export type { ICloudConnectorRef, CloudConnectorReference };
export type { IOpsItemRef, OpsItemReference };
export type { IServiceSettingRef, ServiceSettingReference };
