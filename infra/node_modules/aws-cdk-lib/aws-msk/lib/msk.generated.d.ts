...
import { BatchScramSecretReference, ChannelReference, ClusterPolicyReference, ClusterReference, ConfigurationReference, IBatchScramSecretRef, IChannelRef, IClusterPolicyRef, IClusterRef, IConfigurationRef, IReplicatorRef, IServerlessClusterRef, ITopicRef, IVpcConnectionRef, ReplicatorReference, ServerlessClusterReference, TopicReference, VpcConnectionReference } from "../../interfaces/generated/aws-msk-interfaces.generated";
/**
...
export declare namespace CfnCluster {
    ...
    interface LoggingInfoProperty {
         ...
         */
        readonly authorizerLogs?: CfnCluster.AuthorizerLogsProperty | cdk.IResolvable;
        /**
         * You can configure your MSK cluster to send broker logs to different destination types.
         *
     ...
     */
    interface AuthorizerLogsProperty {
        /**
...
export declare class CfnChannel extends cdk.CfnResource implements cdk.IInspectable, IChannelRef, cdk.ITaggableV2 {
     ...
     * Topic configuration.
     */
    private _topicConfigurationList;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * Encryption configuration.
     */
    get encryptionConfiguration(): CfnChannel.EncryptionConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Encryption configuration.
     */
    set encryptionConfiguration(value: CfnChannel.EncryptionConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Iceberg destination configuration.
     */
    get icebergDestinationConfiguration(): CfnChannel.IcebergDestinationConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * Iceberg destination configuration.
     */
    set icebergDestinationConfiguration(value: CfnChannel.IcebergDestinationConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Log configuration details for Channel.
     */
    get loggingInfo(): CfnChannel.ChannelLoggingInfoProperty | cdk.IResolvable | undefined;
    /**
     * Log configuration details for Channel.
     */
    set loggingInfo(value: CfnChannel.ChannelLoggingInfoProperty | cdk.IResolvable | undefined);
    /**
     * S3 destination configuration.
     */
    get s3DestinationConfiguration(): cdk.IResolvable | CfnChannel.S3DestinationConfigurationProperty | undefined;
    /**
     * S3 destination configuration.
     */
    set s3DestinationConfiguration(value: cdk.IResolvable | CfnChannel.S3DestinationConfigurationProperty | undefined);
    /**
     * Tags attached to the channel.
     */
     ...
     * Topic configuration.
     */
    get topicConfigurationList(): Array<cdk.IResolvable | CfnChannel.TopicConfigurationProperty> | cdk.IResolvable;
    /**
     * Topic configuration.
     */
    set topicConfigurationList(value: Array<cdk.IResolvable | CfnChannel.TopicConfigurationProperty> | cdk.IResolvable);
    /**
     ...
     */
    get attrStateInfo(): cdk.IResolvable;
    /**
...
export declare namespace CfnChannel {
    ...
    interface TopicConfigurationProperty {
         ...
         */
        readonly recordConverter: cdk.IResolvable | CfnChannel.RecordConverterProperty;
        /**
         ...
         */
        readonly recordSchema?: cdk.IResolvable | CfnChannel.RecordSchemaProperty;
        /**
    ...
    interface IcebergDestinationConfigurationProperty {
         ...
         */
        readonly catalog?: CfnChannel.CatalogProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly deadLetterQueueS3: CfnChannel.DeadLetterQueueS3Property | cdk.IResolvable;
        /**
         ...
         */
        readonly destinationTableList: Array<CfnChannel.DestinationTableProperty | cdk.IResolvable> | cdk.IResolvable;
        /**
         ...
         */
        readonly schemaEvolution: cdk.IResolvable | CfnChannel.SchemaEvolutionProperty;
        /**
         ...
         */
        readonly tableCreation: cdk.IResolvable | CfnChannel.TableCreationProperty;
    }
    /**
     * Catalog configuration of the destination.
     *
     ...
     */
    interface SchemaEvolutionProperty {
        /**
         ...
         */
        readonly enableSchemaEvolution: boolean | cdk.IResolvable;
    }
    /**
     * Table creation configuration of the destination.
     *
    ...
    interface TableCreationProperty {
         ...
         */
        readonly enableTableCreation: boolean | cdk.IResolvable;
    }
    /**
    ...
    interface DestinationTableProperty {
         ...
         */
        readonly partitionSpec?: cdk.IResolvable | CfnChannel.PartitionSpecProperty;
    }
    /**
     * Partition specification.
     *
    ...
    interface PartitionSpecProperty {
         ...
         */
        readonly sourceList?: Array<cdk.IResolvable | CfnChannel.PartitionSourceProperty> | cdk.IResolvable;
    }
    /**
    ...
    interface S3DestinationConfigurationProperty {
         ...
         */
        readonly storage: cdk.IResolvable | CfnChannel.S3StorageProperty;
    }
    /**
     * S3 storage configuration.
     *
    ...
    interface ChannelLoggingInfoProperty {
         ...
         */
        readonly cloudWatchLogs?: CfnChannel.CloudWatchLogsLogDestinationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly firehose?: CfnChannel.FirehoseLogDestinationProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly s3?: cdk.IResolvable | CfnChannel.S3LogDestinationProperty;
    }
    /**
     * S3 log destination details.
     *
...
export interface CfnChannelProps {
     ...
     */
    readonly encryptionConfiguration?: CfnChannel.EncryptionConfigurationProperty | cdk.IResolvable;
    /**
     * Iceberg destination configuration.
     *
     ...
     */
    readonly icebergDestinationConfiguration?: CfnChannel.IcebergDestinationConfigurationProperty | cdk.IResolvable;
    /**
     * Log configuration details for Channel.
     *
     ...
     */
    readonly loggingInfo?: CfnChannel.ChannelLoggingInfoProperty | cdk.IResolvable;
    /**
     * S3 destination configuration.
     *
     ...
     */
    readonly s3DestinationConfiguration?: cdk.IResolvable | CfnChannel.S3DestinationConfigurationProperty;
    /**
     * Tags attached to the channel.
     *
     ...
     */
    readonly topicConfigurationList: Array<cdk.IResolvable | CfnChannel.TopicConfigurationProperty> | cdk.IResolvable;
}
/**
...
export declare namespace CfnReplicator {
    ...
    interface KafkaClusterClientAuthenticationProperty {
         ...
         */
        readonly saslOAuthBearer?: cdk.IResolvable | CfnReplicator.KafkaClusterSaslOAuthBearerAuthenticationProperty;
        /**
         * Details for SASL/SCRAM client authentication.
         *
    ...
    interface KafkaClusterSaslOAuthBearerAuthenticationProperty {
         ...
         */
        readonly clientCredentials?: cdk.IResolvable | CfnReplicator.KafkaClusterOAuthClientCredentialsProperty;
        /**
         ...
         */
        readonly clientCredentialsAssertion?: cdk.IResolvable | CfnReplicator.KafkaClusterOAuthClientCredentialsAssertionProperty;
        /**
         ...
         */
        readonly iamJwtBearer?: cdk.IResolvable | CfnReplicator.KafkaClusterOAuthIamJwtBearerProperty;
        /**
