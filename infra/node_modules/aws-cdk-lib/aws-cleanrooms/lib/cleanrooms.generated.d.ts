 ...
 */
export declare class CfnIntermediateTable extends cdk.CfnResource implements cdk.IInspectable, IIntermediateTableRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnIntermediateTable from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnIntermediateTable;
    /**
     * Checks whether the given object is a CfnIntermediateTable
     */
    static isCfnIntermediateTable(x: any): x is CfnIntermediateTable;
    static arnForIntermediateTable(resource: IIntermediateTableRef): string;
    private _analysisRules?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    ...
    private _membershipIdentifier;
    private _name;
    private _populationAnalysisConfiguration;
    private _tags?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnIntermediateTableProps);
    get intermediateTableRef(): IntermediateTableReference;
    get analysisRules(): Array<CfnIntermediateTable.IntermediateTableAnalysisRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    set analysisRules(value: Array<CfnIntermediateTable.IntermediateTableAnalysisRuleProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    get description(): string | undefined;
    set description(value: string | undefined);
    get kmsKeyArn(): string | undefined;
    set kmsKeyArn(value: string | undefined);
    ...
    get name(): string;
    set name(value: string);
    get populationAnalysisConfiguration(): cdk.IResolvable | CfnIntermediateTable.PopulationAnalysisConfigurationProperty;
    set populationAnalysisConfiguration(value: cdk.IResolvable | CfnIntermediateTable.PopulationAnalysisConfigurationProperty);
    get tags(): Array<cdk.CfnTag> | undefined;
    set tags(value: Array<cdk.CfnTag> | undefined);
    /**
     * @cloudformationAttribute Arn
     ...
     */
    get attrIntermediateTableIdentifier(): string;
    /**
     * @cloudformationAttribute MembershipArn
     */
    get attrMembershipArn(): string;
...
export declare namespace CfnIntermediateTable {
    /**
     * @struct
     * @stability external
    ...
    interface PopulationAnalysisConfigurationProperty {
         ...
         */
        readonly sqlParameters?: cdk.IResolvable | CfnIntermediateTable.PopulationAnalysisSqlParametersProperty;
    }
    /**
     * @struct
     * @stability external
    ...
    interface IntermediateTableAnalysisRuleProperty {
         ...
         */
        readonly policy: CfnIntermediateTable.IntermediateTableAnalysisRulePolicyProperty | cdk.IResolvable;
        /**
    ...
    interface IntermediateTableAnalysisRulePolicyProperty {
         ...
         */
        readonly v1: CfnIntermediateTable.IntermediateTableAnalysisRulePolicyV1Property | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface IntermediateTableAnalysisRulePolicyV1Property {
         ...
         */
        readonly custom: CfnIntermediateTable.IntermediateTableAnalysisRuleCustomProperty | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
    ...
    interface IntermediateTableAnalysisRuleCustomProperty {
         ...
         */
        readonly differentialPrivacy?: CfnIntermediateTable.DifferentialPrivacyProperty | cdk.IResolvable;
        /**
    ...
    interface DifferentialPrivacyProperty {
         ...
         */
        readonly columns: Array<CfnIntermediateTable.DifferentialPrivacyColumnProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cleanrooms-intermediatetable.html
 */
export interface CfnIntermediateTableProps {
    /**
     ...
     */
    readonly analysisRules?: Array<CfnIntermediateTable.IntermediateTableAnalysisRuleProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     ...
     */
    readonly populationAnalysisConfiguration: cdk.IResolvable | CfnIntermediateTable.PopulationAnalysisConfigurationProperty;
    /**
...
export type { IIntermediateTableRef, IntermediateTableReference };
