...
import { CaseReference, CaseRuleReference, DomainReference, FieldReference, ICaseRef, ICaseRuleRef, IDomainRef, IFieldRef, ILayoutRef, ITemplateRef, LayoutReference, TemplateReference } from "../../interfaces/generated/aws-cases-interfaces.generated";
/**
 ...
 */
export declare class CfnCase extends cdk.CfnResource implements cdk.IInspectable, ICaseRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnCase from CloudFormation properties
     *
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnCase;
    /**
     * Checks whether the given object is a CfnCase
     */
    static isCfnCase(x: any): x is CfnCase;
    static arnForCase(resource: ICaseRef): string;
    /**
     ...
     */
    constructor(scope: constructs.Construct, id: string, props: CfnCaseProps);
    get caseRef(): CaseReference;
    /**
     * The full customer profile ARN for the case.
     */
...
export type { ICaseRef, CaseReference };
