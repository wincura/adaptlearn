...
export declare class CfnEnvironment extends cdk.CfnResource implements cdk.IInspectable, IEnvironmentRef, cdk.ITaggableV2 {
     ...
     * The connectivity configuration for the environment.
     */
    get connectivityInfo(): CfnEnvironment.ConnectivityInfoProperty | cdk.IResolvable | undefined;
    /**
     * The connectivity configuration for the environment.
     */
    set connectivityInfo(value: CfnEnvironment.ConnectivityInfoProperty | cdk.IResolvable | undefined);
    /**
     * The name of the environment.
     */
     ...
     * The license information that Amazon EVS requires to create an environment.
     */
    get licenseInfo(): cdk.IResolvable | CfnEnvironment.LicenseInfoProperty | undefined;
    /**
     * The license information that Amazon EVS requires to create an environment.
     */
    set licenseInfo(value: cdk.IResolvable | CfnEnvironment.LicenseInfoProperty | undefined);
    /**
     * The security groups that allow traffic between the Amazon EVS control plane and your VPC for service access.
     */
     ...
     * The DNS hostnames to be used by the VCF management appliances in your environment.
     */
    get vcfHostnames(): cdk.IResolvable | CfnEnvironment.VcfHostnamesProperty | undefined;
    /**
     * The DNS hostnames to be used by the VCF management appliances in your environment.
     */
    set vcfHostnames(value: cdk.IResolvable | CfnEnvironment.VcfHostnamesProperty | undefined);
    /**
     * The VCF version of the environment.
     */
