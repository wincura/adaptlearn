...
import { BudgetReference, FarmReference, FleetReference, IBudgetRef, IFarmRef, IFleetRef, ILicenseEndpointRef, ILimitRef, IMeteredProductRef, IMonitorRef, IQueueEnvironmentRef, IQueueFleetAssociationRef, IQueueLimitAssociationRef, IQueueRef, IStorageProfileRef, IWorkerRef, LicenseEndpointReference, LimitReference, MeteredProductReference, MonitorReference, QueueEnvironmentReference, QueueFleetAssociationReference, QueueLimitAssociationReference, QueueReference, StorageProfileReference, WorkerReference } from "../../interfaces/generated/aws-deadline-interfaces.generated";
/**
 ...
 */
export declare class CfnBudget extends cdk.CfnResource implements cdk.IInspectable, IBudgetRef, cdk.ITaggableV2 {
    /**
    ...
    static arnForBudget(resource: IBudgetRef): string;
    /**
     ...
     */
    private _approximateDollarLimit;
    /**
     ...
     */
    private _usageTrackingResource;
     ...
     * The budget actions to specify what happens when the budget runs out.
     */
    get actions(): Array<CfnBudget.BudgetActionToAddProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The budget actions to specify what happens when the budget runs out.
     */
    set actions(value: Array<CfnBudget.BudgetActionToAddProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * The dollar limit based on consumed usage.
     */
    get approximateDollarLimit(): number;
    /**
     * The dollar limit based on consumed usage.
     */
    set approximateDollarLimit(value: number);
    /**
     * The description of the budget.
     */
     ...
     * The start and end time of the budget.
     */
    get schedule(): CfnBudget.BudgetScheduleProperty | cdk.IResolvable;
    /**
     * The start and end time of the budget.
     */
    set schedule(value: CfnBudget.BudgetScheduleProperty | cdk.IResolvable);
    /**
     * An array of key-value pairs to apply to this resource.
     */
     ...
     * The usage details of the allotted budget.
     */
    get usageTrackingResource(): cdk.IResolvable | CfnBudget.UsageTrackingResourceProperty;
    /**
     * The usage details of the allotted budget.
     */
    set usageTrackingResource(value: cdk.IResolvable | CfnBudget.UsageTrackingResourceProperty);
    /**
...
export declare namespace CfnBudget {
    ...
    interface BudgetScheduleProperty {
         ...
         */
        readonly fixed: CfnBudget.FixedBudgetScheduleProperty | cdk.IResolvable;
    }
    /**
     * The details of a fixed budget schedule.
     *
...
export interface CfnBudgetProps {
     ...
     */
    readonly actions: Array<CfnBudget.BudgetActionToAddProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * The dollar limit based on consumed usage.
     *
     ...
     */
    readonly schedule: CfnBudget.BudgetScheduleProperty | cdk.IResolvable;
    /**
     * An array of key-value pairs to apply to this resource.
     *
     ...
     */
    readonly usageTrackingResource: cdk.IResolvable | CfnBudget.UsageTrackingResourceProperty;
}
/**
 ...
 */
export declare class CfnWorker extends cdk.CfnResource implements cdk.IInspectable, IWorkerRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnWorker from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnWorker;
    /**
     * Checks whether the given object is a CfnWorker
     */
    static isCfnWorker(x: any): x is CfnWorker;
    static arnForWorker(resource: IWorkerRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnWorkerProps);
    get workerRef(): WorkerReference;
    /**
     * The farm ID.
     */
    get farmId(): string;
     ...
     * The host property details.
     */
    get hostProperties(): CfnWorker.HostPropertiesRequestProperty | cdk.IResolvable | undefined;
    /**
     * The host property details.
     */
    set hostProperties(value: CfnWorker.HostPropertiesRequestProperty | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<CfnWorker.TagsItemsProperty> | undefined;
    /**
     * An array of key-value pairs to apply to this resource.
     */
    set tags(value: Array<CfnWorker.TagsItemsProperty> | undefined);
    /**
...
export declare namespace CfnWorker {
    /**
     * The host property details.
     *
     * @struct
    ...
    interface HostPropertiesRequestProperty {
         ...
         */
        readonly ipAddresses?: CfnWorker.IpAddressesProperty | cdk.IResolvable;
    }
    /**
     * The IP addresses for a host.
     *
    ...
    interface IpAddressesProperty {
         ...
         */
        readonly ipV6Addresses?: Array<string>;
    }
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-deadline-worker.html
 */
export interface CfnWorkerProps {
    /**
     * The farm ID.
     *
     ...
     */
    readonly hostProperties?: CfnWorker.HostPropertiesRequestProperty | cdk.IResolvable;
    /**
     * An array of key-value pairs to apply to this resource.
     *
     ...
     */
    readonly tags?: Array<CfnWorker.TagsItemsProperty>;
}
...
export type { IWorkerRef, WorkerReference };
