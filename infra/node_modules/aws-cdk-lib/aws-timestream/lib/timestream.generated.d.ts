...
export declare class CfnInfluxDBCluster extends cdk.CfnResource implements cdk.IInspectable, IInfluxDBClusterRef, cdk.ITaggableV2 {
     ...
     * The maintenance schedule for the InfluxDB cluster.
     */
    get maintenanceSchedule(): cdk.IResolvable | CfnInfluxDBCluster.MaintenanceScheduleProperty | undefined;
    /**
     * The maintenance schedule for the InfluxDB cluster.
     */
    set maintenanceSchedule(value: cdk.IResolvable | CfnInfluxDBCluster.MaintenanceScheduleProperty | undefined);
    /**
     * The unique name that is associated with the InfluxDB cluster.
     */
     ...
     */
    get attrNextMaintenanceTime(): string;
    /**
...
export interface CfnInfluxDBClusterProps {
     ...
     */
    readonly maintenanceSchedule?: cdk.IResolvable | CfnInfluxDBCluster.MaintenanceScheduleProperty;
    /**
     * The unique name that is associated with the InfluxDB cluster.
     *
...
export declare class CfnInfluxDBInstance extends cdk.CfnResource implements cdk.IInspectable, IInfluxDBInstanceRef, cdk.ITaggableV2 {
     ...
     * The maintenance schedule for the InfluxDB instance.
     */
    get maintenanceSchedule(): cdk.IResolvable | CfnInfluxDBInstance.MaintenanceScheduleProperty | undefined;
    /**
     * The maintenance schedule for the InfluxDB instance.
     */
    set maintenanceSchedule(value: cdk.IResolvable | CfnInfluxDBInstance.MaintenanceScheduleProperty | undefined);
    /**
     * The name that uniquely identifies the DB instance when interacting with the Amazon Timestream for InfluxDB API and CLI commands.
     */
    get name(): string | undefined;
...
export interface CfnInfluxDBInstanceProps {
     ...
     */
    readonly maintenanceSchedule?: cdk.IResolvable | CfnInfluxDBInstance.MaintenanceScheduleProperty;
    /**
     * The name that uniquely identifies the DB instance when interacting with the Amazon Timestream for InfluxDB API and CLI commands.
     *
