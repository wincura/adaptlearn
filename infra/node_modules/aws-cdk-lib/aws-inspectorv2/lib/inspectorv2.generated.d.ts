...
import { CisScanConfigurationReference, CodeSecurityIntegrationReference, CodeSecurityScanConfigurationReference, ConnectorReference, FilterReference, ICisScanConfigurationRef, ICodeSecurityIntegrationRef, ICodeSecurityScanConfigurationRef, IConnectorRef, IFilterRef } from "../../interfaces/generated/aws-inspectorv2-interfaces.generated";
/**
...
export declare class CfnConnector extends cdk.CfnResource implements cdk.IInspectable, IConnectorRef, cdk.ITaggableV2 {
    ...
    get providerConfiguration(): cdk.IResolvable | CfnConnector.ProviderConfigurationProperty;
    set providerConfiguration(value: cdk.IResolvable | CfnConnector.ProviderConfigurationProperty);
    /**
     * Tags to apply to the connector.
     */
     ...
     */
    get attrHealth(): cdk.IResolvable;
    /**
     ...
     */
    get attrProviderConfigurationAzureScopeConfigurationContainerImageScanningState(): string;
    /**
     ...
     */
    get attrProviderConfigurationAzureScopeConfigurationContainerImageScanningStateReason(): string;
    /**
     * @cloudformationAttribute ProviderConfiguration.Azure.ScopeConfiguration.ServerlessScanning.State
     */
    get attrProviderConfigurationAzureScopeConfigurationServerlessScanningState(): string;
    /**
     * Reason for the current scope state.
     *
     * @cloudformationAttribute ProviderConfiguration.Azure.ScopeConfiguration.ServerlessScanning.StateReason
     */
    get attrProviderConfigurationAzureScopeConfigurationServerlessScanningStateReason(): string;
    /**
     * @cloudformationAttribute ProviderConfiguration.Azure.ScopeConfiguration.VmScanning.State
     */
    get attrProviderConfigurationAzureScopeConfigurationVmScanningState(): string;
    /**
     * Reason for the current scope state.
     *
     * @cloudformationAttribute ProviderConfiguration.Azure.ScopeConfiguration.VmScanning.StateReason
     */
    get attrProviderConfigurationAzureScopeConfigurationVmScanningStateReason(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnConnector {
     ...
     */
    interface ProviderConfigurationProperty {
        /**
    ...
    interface AzureProviderConfigurationProperty {
         ...
         */
        readonly autoInstallVmScanner?: boolean | cdk.IResolvable;
        /**
         ...
         */
        readonly scopeConfiguration: CfnConnector.AzureScopeConfigurationMapProperty | cdk.IResolvable;
    }
    /**
     * Defines which resource types to scan and at what scope level.
     *
    ...
    interface AzureScopeConfigurationMapProperty {
         ...
         */
        readonly containerImageScanning?: cdk.IResolvable | CfnConnector.ScopeConfigurationProperty;
        /**
         * Defines the scope of Azure resources to monitor for a specific resource type.
         *
         ...
         */
        readonly serverlessScanning?: cdk.IResolvable | CfnConnector.ScopeConfigurationProperty;
        /**
         * Defines the scope of Azure resources to monitor for a specific resource type.
         *
         ...
         */
        readonly vmScanning?: cdk.IResolvable | CfnConnector.ScopeConfigurationProperty;
    }
    /**
     * Defines the scope of Azure resources to monitor for a specific resource type.
     *
     ...
     */
    interface ConnectorHealthProperty {
        /**
...
export interface CfnConnectorProps {
     ...
     */
    readonly providerConfiguration: cdk.IResolvable | CfnConnector.ProviderConfigurationProperty;
    /**
     * Tags to apply to the connector.
     *
