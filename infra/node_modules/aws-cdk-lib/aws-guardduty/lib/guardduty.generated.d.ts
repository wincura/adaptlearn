...
export declare namespace CfnFilter {
    ...
    interface ConditionProperty {
         ...
         */
        readonly notMatches?: Array<string>;
    }
}
/**
 ...
 */
export declare class CfnCustomDetectionRuleAssociation extends cdk.CfnResource implements cdk.IInspectable, ICustomDetectionRuleAssociationRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnCustomDetectionRuleAssociation from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnCustomDetectionRuleAssociation;
    /**
     * Checks whether the given object is a CfnCustomDetectionRuleAssociation
     */
    static isCfnCustomDetectionRuleAssociation(x: any): x is CfnCustomDetectionRuleAssociation;
    static arnForCustomDetectionRuleAssociation(resource: ICustomDetectionRuleAssociationRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnCustomDetectionRuleAssociationProps);
    get customDetectionRuleAssociationRef(): CustomDetectionRuleAssociationReference;
    /**
     * Whether the rule runs in LIVE mode (generates findings) or DRY_RUN mode (evaluates without generating findings).
     */
    get mode(): string;
     ...
     * The tags applied to the association.
     */
    get tags(): Array<CfnCustomDetectionRuleAssociation.TagItemProperty> | undefined;
    /**
     * The tags applied to the association.
     */
    set tags(value: Array<CfnCustomDetectionRuleAssociation.TagItemProperty> | undefined);
    /**
...
export declare namespace CfnCustomDetectionRuleAssociation {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-guardduty-customdetectionruleassociation.html
 */
export interface CfnCustomDetectionRuleAssociationProps {
    /**
     * Whether the rule runs in LIVE mode (generates findings) or DRY_RUN mode (evaluates without generating findings).
     *
     ...
     */
    readonly tags?: Array<CfnCustomDetectionRuleAssociation.TagItemProperty>;
}
/**
...
export type { ICustomDetectionRuleAssociationRef, CustomDetectionRuleAssociationReference };
