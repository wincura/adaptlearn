...
import { GrantReference, IGrantRef, ILicenseAssetRuleSetRef, ILicenseRef, LicenseAssetRuleSetReference, LicenseReference } from "../../interfaces/generated/aws-licensemanager-interfaces.generated";
/**
 * Specifies a grant.
 *
 ...
 */
export declare class CfnLicenseAssetRuleSet extends cdk.CfnResource implements cdk.IInspectable, ILicenseAssetRuleSetRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnLicenseAssetRuleSet from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnLicenseAssetRuleSet;
    /**
     * Checks whether the given object is a CfnLicenseAssetRuleSet
     */
    static isCfnLicenseAssetRuleSet(x: any): x is CfnLicenseAssetRuleSet;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnLicenseAssetRuleSetProps);
    get licenseAssetRuleSetRef(): LicenseAssetRuleSetReference;
    /**
     * License asset ruleset description.
     */
     ...
     * License asset rules.
     */
    get rules(): Array<cdk.IResolvable | CfnLicenseAssetRuleSet.LicenseAssetRuleProperty> | cdk.IResolvable;
    /**
     * License asset rules.
     */
    set rules(value: Array<cdk.IResolvable | CfnLicenseAssetRuleSet.LicenseAssetRuleProperty> | cdk.IResolvable);
    /**
     * Tags to add to the license asset ruleset.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrLicenseAssetRulesetArn(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnLicenseAssetRuleSet {
    /**
     * License asset rule.
     *
     * @struct
    ...
    interface LicenseAssetRuleProperty {
         ...
         */
        readonly ruleStatement: cdk.IResolvable | CfnLicenseAssetRuleSet.RuleStatementProperty;
    }
    /**
     * Rule statement.
     *
    ...
    interface RuleStatementProperty {
         ...
         */
        readonly instanceRuleStatement?: CfnLicenseAssetRuleSet.InstanceRuleStatementProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly licenseConfigurationRuleStatement?: cdk.IResolvable | CfnLicenseAssetRuleSet.LicenseConfigurationRuleStatementProperty;
        /**
         ...
         */
        readonly licenseRuleStatement?: cdk.IResolvable | CfnLicenseAssetRuleSet.LicenseRuleStatementProperty;
    }
    /**
     * Instance rule statement.
     *
    ...
    interface InstanceRuleStatementProperty {
         ...
         */
        readonly andRuleStatement?: CfnLicenseAssetRuleSet.AndRuleStatementProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly matchingRuleStatement?: cdk.IResolvable | CfnLicenseAssetRuleSet.MatchingRuleStatementProperty;
        /**
         * OR rule statement.
         *
         ...
         */
        readonly orRuleStatement?: cdk.IResolvable | CfnLicenseAssetRuleSet.OrRuleStatementProperty;
    }
    /**
     * AND rule statement.
     *
    ...
    interface AndRuleStatementProperty {
         ...
         */
        readonly matchingRuleStatements?: Array<cdk.IResolvable | CfnLicenseAssetRuleSet.MatchingRuleStatementProperty> | cdk.IResolvable;
    }
    /**
     * Matching rule statement.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-licensemanager-licenseassetruleset.html
 */
export interface CfnLicenseAssetRuleSetProps {
    /**
     * License asset ruleset description.
     *
     ...
     */
    readonly rules: Array<cdk.IResolvable | CfnLicenseAssetRuleSet.LicenseAssetRuleProperty> | cdk.IResolvable;
    /**
     * Tags to add to the license asset ruleset.
     *
...
export type { ILicenseAssetRuleSetRef, LicenseAssetRuleSetReference };
