...
export declare class CfnCanary extends cdk.CfnResource implements cdk.IInspectable, ICanaryRef, cdk.ITaggable {
     ...
     * List of replica locations for multi-location canary execution.
     */
    get replicas(): Array<cdk.IResolvable | CfnCanary.ReplicaProperty> | cdk.IResolvable | undefined;
    /**
     * List of replica locations for multi-location canary execution.
     */
    set replicas(value: Array<cdk.IResolvable | CfnCanary.ReplicaProperty> | cdk.IResolvable | undefined);
    /**
     * To have the tags that you apply to this canary also be applied to the Lambda function that the canary uses, specify this property with the value `lambda-function` .
     */
...
export declare namespace CfnCanary {
    ...
    interface ReplicaProperty {
         ...
         */
        readonly replicationStatus?: cdk.IResolvable | CfnCanary.ReplicaReplicationStatusProperty;
        /**
     ...
     */
    interface ReplicaReplicationStatusProperty {
        /**
...
export interface CfnCanaryProps {
     ...
     */
    readonly replicas?: Array<cdk.IResolvable | CfnCanary.ReplicaProperty> | cdk.IResolvable;
    /**
     * To have the tags that you apply to this canary also be applied to the Lambda function that the canary uses, specify this property with the value `lambda-function` .
     *
