...
import { AccessEntryReference, AddonReference, CapabilityReference, CertificateAuthorityReference, ClusterReference, FargateProfileReference, IAccessEntryRef, IAddonRef, ICapabilityRef, ICertificateAuthorityRef, IClusterRef, IdentityProviderConfigReference, IFargateProfileRef, IIdentityProviderConfigRef, INodegroupRef, IPodIdentityAssociationRef, NodegroupReference, PodIdentityAssociationReference } from "../../interfaces/generated/aws-eks-interfaces.generated";
/**
...
export declare class CfnCluster extends cdk.CfnResource implements cdk.IInspectable, IClusterRef, cdk.ITaggable {
     ...
     */
    private _activeCertificateAuthorityId?;
    /**
     ...
     * The ID of the certificate authority to activate as the cluster's signing CA.
     */
    get activeCertificateAuthorityId(): string | undefined;
    /**
     * The ID of the certificate authority to activate as the cluster's signing CA.
     */
    set activeCertificateAuthorityId(value: string | undefined);
    /**
     * If you set this value to `False` when creating a cluster, the default networking add-ons will not be installed.
     */
     ...
     * The certificate authority information for the cluster, including the trust bundle and the currently active signing certificate authority.
     */
    get certificateAuthority(): CfnCluster.CertificateAuthorityProperty | cdk.IResolvable | undefined;
    /**
     * The certificate authority information for the cluster, including the trust bundle and the currently active signing certificate authority.
     */
    set certificateAuthority(value: CfnCluster.CertificateAuthorityProperty | cdk.IResolvable | undefined);
    /**
     * Indicates the current configuration of the compute capability on your EKS Auto Mode cluster.
     */
     ...
     * The configuration for the Kubernetes API server on an Amazon EKS cluster.
     */
    get kubeApiServerConfig(): cdk.IResolvable | CfnCluster.KubeApiServerConfigProperty | undefined;
    /**
     * The configuration for the Kubernetes API server on an Amazon EKS cluster.
     */
    set kubeApiServerConfig(value: cdk.IResolvable | CfnCluster.KubeApiServerConfigProperty | undefined);
    /**
     * The configuration for the Kubernetes controller manager on an Amazon EKS cluster.
     */
    get kubeControllerManagerConfig(): cdk.IResolvable | CfnCluster.KubeControllerManagerConfigProperty | undefined;
    /**
     * The configuration for the Kubernetes controller manager on an Amazon EKS cluster.
     */
    set kubeControllerManagerConfig(value: cdk.IResolvable | CfnCluster.KubeControllerManagerConfigProperty | undefined);
    /**
     * The Kubernetes network configuration for the cluster.
     */
     ...
     * The configuration for the Kubernetes scheduler on an Amazon EKS cluster.
     */
    get kubeSchedulerConfig(): cdk.IResolvable | CfnCluster.KubeSchedulerConfigProperty | undefined;
    /**
     * The configuration for the Kubernetes scheduler on an Amazon EKS cluster.
     */
    set kubeSchedulerConfig(value: cdk.IResolvable | CfnCluster.KubeSchedulerConfigProperty | undefined);
    /**
     * The logging configuration for your cluster.
     */
     ...
     */
    get attrCertificateAuthorityCertificateData(): string;
    /**
...
export declare namespace CfnCluster {
    ...
    interface CertificateAuthorityProperty {
         ...
         */
        readonly active?: CfnCluster.ActiveCertificateAuthorityProperty | cdk.IResolvable;
        /**
         * The base64-encoded certificate-authority trust bundle for the cluster (all trusted CAs).
         *
    ...
    interface KubeApiServerConfigProperty {
         ...
         */
        readonly serviceNodePortRange?: cdk.IResolvable | CfnCluster.ServiceNodePortRangeProperty;
    }
    /**
     * The port range for Kubernetes NodePort services.
     *
    ...
    interface KubeSchedulerConfigProperty {
         ...
         */
        readonly nodeResourcesFit?: cdk.IResolvable | CfnCluster.NodeResourcesFitConfigProperty;
    }
    /**
     * The NodeResourcesFit plugin configuration for the Kubernetes scheduler.
     *
    ...
    interface NodeResourcesFitConfigProperty {
         ...
         */
        readonly scoringStrategy?: cdk.IResolvable | CfnCluster.ScoringStrategyProperty;
    }
    /**
     * The scoring strategy configuration for the NodeResourcesFit scheduler plugin.
     *
    ...
    interface ScoringStrategyProperty {
         ...
         */
        readonly resources?: Array<cdk.IResolvable | CfnCluster.ResourceWeightProperty> | cdk.IResolvable;
        /**
    ...
    interface KubeControllerManagerConfigProperty {
         ...
         */
        readonly horizontalPodAutoscalerControllerConfig?: CfnCluster.HorizontalPodAutoscalerControllerConfigProperty | cdk.IResolvable;
        /**
         ...
         */
        readonly podGcControllerConfig?: cdk.IResolvable | CfnCluster.PodGcControllerConfigProperty;
    }
    /**
     * The pod garbage collector controller configuration.
     *
...
export interface CfnClusterProps {
     ...
     */
    readonly activeCertificateAuthorityId?: string;
    /**
     * If you set this value to `False` when creating a cluster, the default networking add-ons will not be installed.
     *
     ...
     */
    readonly certificateAuthority?: CfnCluster.CertificateAuthorityProperty | cdk.IResolvable;
    /**
     * Indicates the current configuration of the compute capability on your EKS Auto Mode cluster.
     *
     * For example, if the capability is enabled or disabled. If the compute capability is enabled, EKS Auto Mode will create and delete EC2 Managed Instances in your AWS account. For more information, see EKS Auto Mode compute capability in the *Amazon EKS User Guide* .
     ...
     */
    readonly kubeApiServerConfig?: cdk.IResolvable | CfnCluster.KubeApiServerConfigProperty;
    /**
     * The configuration for the Kubernetes controller manager on an Amazon EKS cluster.
     *
     ...
     */
    readonly kubeControllerManagerConfig?: cdk.IResolvable | CfnCluster.KubeControllerManagerConfigProperty;
    /**
     * The Kubernetes network configuration for the cluster.
     *
     ...
     */
    readonly kubeSchedulerConfig?: cdk.IResolvable | CfnCluster.KubeSchedulerConfigProperty;
    /**
     * The logging configuration for your cluster.
     *
...
export declare namespace CfnCapability {
    ...
    interface CapabilityConfigurationProperty {
         ...
         */
        readonly ack?: any | cdk.IResolvable;
        /**
 ...
 */
export declare class CfnCertificateAuthority extends cdk.CfnResource implements cdk.IInspectable, ICertificateAuthorityRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
     ...
     */
    get attrDistributionStatus(): string;
    /**
     ...
     */
    get attrRollbackAvailable(): cdk.IResolvable;
    /**
     ...
     */
    get attrScheduledEvents(): cdk.IResolvable;
    /**
     ...
     */
    get attrScheduledEventsFinalAutoActivation(): string;
    /**
...
export declare namespace CfnCertificateAuthority {
    ...
    interface ScheduledEventsProperty {
         ...
         */
        readonly finalAutoActivation?: string;
        /**
         * The earliest date EKS may auto-activate this certificate authority (notAfter minus 6 months).
         *
         ...
         */
        readonly firstAutoActivation?: string;
    }
}
/**
