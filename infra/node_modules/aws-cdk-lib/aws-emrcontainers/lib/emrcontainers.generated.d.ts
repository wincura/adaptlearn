...
export declare class CfnVirtualCluster extends cdk.CfnResource implements cdk.IInspectable, IVirtualClusterRef, cdk.ITaggable {
     ...
     * Whether the virtual cluster is session-enabled for Spark Connect.
     */
    get sessionEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether the virtual cluster is session-enabled for Spark Connect.
     */
    set sessionEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
...
export interface CfnVirtualClusterProps {
     ...
     */
    readonly sessionEnabled?: boolean | cdk.IResolvable;
    /**
     * An array of key-value pairs to apply to this resource.
     *
...
export declare class CfnEndpoint extends cdk.CfnResource implements cdk.IInspectable, IEndpointRef, cdk.ITaggableV2 {
     ...
     */
    private _sessionIdleTimeoutInMinutes?;
    /**
     ...
     * The idle timeout in minutes for sessions on the managed endpoint.
     */
    get sessionIdleTimeoutInMinutes(): number | undefined;
    /**
     * The idle timeout in minutes for sessions on the managed endpoint.
     */
    set sessionIdleTimeoutInMinutes(value: number | undefined);
    /**
     * An array of key-value pairs to apply to this managed endpoint.
     */
     ...
     *
     * @cloudformationAttribute AuthProxyUrl
     */
    get attrAuthProxyUrl(): string;
    /**
