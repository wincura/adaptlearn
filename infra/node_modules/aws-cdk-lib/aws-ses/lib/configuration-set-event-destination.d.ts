...
export declare class ConfigurationSetEventDestination extends Resource implements IConfigurationSetEventDestination {
     ...
     */
    static fromConfigurationSetEventDestinationAttributes(scope: Construct, id: string, attrs: ConfigurationSetEventDestinationAttributes): IConfigurationSetEventDestination;
    readonly configurationSetEventDestinationId: string;
    private readonly configurationSetName;
