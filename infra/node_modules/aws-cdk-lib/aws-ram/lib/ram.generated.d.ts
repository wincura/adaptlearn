...
export declare class CfnResourceShare extends cdk.CfnResource implements cdk.IInspectable, IResourceShareRef, cdk.ITaggable {
     ...
     * The configuration for a resource share.
     */
    get resourceShareConfiguration(): cdk.IResolvable | CfnResourceShare.ResourceShareConfigurationProperty | undefined;
    /**
     * The configuration for a resource share.
     */
    set resourceShareConfiguration(value: cdk.IResolvable | CfnResourceShare.ResourceShareConfigurationProperty | undefined);
    /**
     * Specifies from which source accounts the service principal has access to the resources in this resource share.
     */
...
export declare namespace CfnResourceShare {
    /**
     * The configuration for a resource share.
     *
     * @struct
    ...
    interface ResourceShareConfigurationProperty {
         ...
         */
        readonly exclusiveAccountAccess?: boolean | cdk.IResolvable;
        /**
         ...
         */
        readonly retainSharingOnAccountLeaveOrganization?: boolean | cdk.IResolvable;
    }
}
/**
...
export interface CfnResourceShareProps {
     ...
     */
    readonly resourceShareConfiguration?: cdk.IResolvable | CfnResourceShare.ResourceShareConfigurationProperty;
    /**
     * Specifies from which source accounts the service principal has access to the resources in this resource share.
     *
