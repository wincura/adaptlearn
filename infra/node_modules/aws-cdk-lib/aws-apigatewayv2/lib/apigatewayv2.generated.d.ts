...
import { ApiGatewayManagedOverridesReference, ApiMappingReference, ApiReference, AuthorizerReference, DeploymentReference, DomainNameReference, IApiGatewayManagedOverridesRef, IApiMappingRef, IApiRef, IAuthorizerRef, IDeploymentRef, IDomainNameRef, IIntegrationRef, IIntegrationResponseRef, IModelRef, IntegrationReference, IntegrationResponseReference, IPortalProductRef, IRouteRef, IRouteResponseRef, IRoutingRuleRef, IStageRef, IVpcLinkRef, ModelReference, PortalProductReference, RouteReference, RouteResponseReference, RoutingRuleReference, StageReference, VpcLinkReference } from "../../interfaces/generated/aws-apigatewayv2-interfaces.generated";
/**
 ...
 */
export declare class CfnPortalProduct extends cdk.CfnResource implements cdk.IInspectable, IPortalProductRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnPortalProduct from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnPortalProduct;
    /**
     * Checks whether the given object is a CfnPortalProduct
     */
    static isCfnPortalProduct(x: any): x is CfnPortalProduct;
    static arnForPortalProduct(resource: IPortalProductRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnPortalProductProps);
    get portalProductRef(): PortalProductReference;
    /**
     * A description of the portal product.
     */
    get description(): string | undefined;
     ...
     */
    get attrPortalProductArn(): string;
    /**
     * The portal product identifier.
     *
     * @cloudformationAttribute PortalProductId
     */
    get attrPortalProductId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-apigatewayv2-portalproduct.html
 */
export interface CfnPortalProductProps {
    /**
     * A description of the portal product.
     *
...
export type { IPortalProductRef, PortalProductReference };
