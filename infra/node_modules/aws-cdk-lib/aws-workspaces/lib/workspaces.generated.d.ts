...
import { ConnectionAliasReference, IConnectionAliasRef, IWorkspaceIpGroupRef, IWorkspaceRef, IWorkspacesPoolRef, WorkspaceIpGroupReference, WorkspaceReference, WorkspacesPoolReference } from "../../interfaces/generated/aws-workspaces-interfaces.generated";
/**
 ...
 */
export declare class CfnWorkspaceIpGroup extends cdk.CfnResource implements cdk.IInspectable, IWorkspaceIpGroupRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnWorkspaceIpGroup from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnWorkspaceIpGroup;
    /**
     * Checks whether the given object is a CfnWorkspaceIpGroup
     */
    static isCfnWorkspaceIpGroup(x: any): x is CfnWorkspaceIpGroup;
    static arnForWorkspaceIpGroup(resource: IWorkspaceIpGroupRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnWorkspaceIpGroupProps);
    get workspaceIpGroupRef(): WorkspaceIpGroupReference;
    /**
     * The description of the group.
     */
    get groupDesc(): string | undefined;
    /**
     * The description of the group.
     */
    set groupDesc(value: string | undefined);
    /**
     * The name of the group.
     */
     ...
     * The rules for the IP access control group.
     */
    get userRules(): Array<CfnWorkspaceIpGroup.IpRuleItemProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * The rules for the IP access control group.
     */
    set userRules(value: Array<CfnWorkspaceIpGroup.IpRuleItemProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
...
export declare namespace CfnWorkspaceIpGroup {
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-workspaces-workspaceipgroup.html
 */
export interface CfnWorkspaceIpGroupProps {
    /**
     * The description of the group.
     *
     ...
     */
    readonly userRules?: Array<CfnWorkspaceIpGroup.IpRuleItemProperty | cdk.IResolvable> | cdk.IResolvable;
}
/**
...
export type { IWorkspaceIpGroupRef, WorkspaceIpGroupReference };
