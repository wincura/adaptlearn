 ...
 */
export declare class CfnServerlessCacheSnapshot extends cdk.CfnResource implements cdk.IInspectable, IServerlessCacheSnapshotRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnServerlessCacheSnapshot from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnServerlessCacheSnapshot;
    /**
     * Checks whether the given object is a CfnServerlessCacheSnapshot
     */
    static isCfnServerlessCacheSnapshot(x: any): x is CfnServerlessCacheSnapshot;
    static arnForServerlessCacheSnapshot(resource: IServerlessCacheSnapshotRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _serverlessCacheSnapshotName;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnServerlessCacheSnapshotProps);
    get serverlessCacheSnapshotRef(): ServerlessCacheSnapshotReference;
    /**
     * The Amazon Resource Name (ARN) of the AWS KMS key used to encrypt the snapshot.
     */
    get kmsKeyId(): string | undefined;
     ...
     * The name of the serverless cache snapshot.
     */
    get serverlessCacheSnapshotName(): string;
    /**
     * The name of the serverless cache snapshot.
     */
    set serverlessCacheSnapshotName(value: string);
    /**
     * A list of tags to be added to the serverless cache snapshot resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrBytesUsedForCache(): string;
    /**
     ...
     */
    get attrServerlessCacheConfiguration(): cdk.IResolvable;
    /**
...
export declare namespace CfnServerlessCacheSnapshot {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-elasticache-serverlesscachesnapshot.html
 */
export interface CfnServerlessCacheSnapshotProps {
    /**
     * The Amazon Resource Name (ARN) of the AWS KMS key used to encrypt the snapshot.
     *
...
export type { IServerlessCacheSnapshotRef, ServerlessCacheSnapshotReference };
