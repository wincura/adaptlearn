...
import { DatasetGroupReference, DatasetReference, EventTrackerReference, IDatasetGroupRef, IDatasetRef, IEventTrackerRef, IMetricAttributionRef, ISchemaRef, ISolutionRef, MetricAttributionReference, SchemaReference, SolutionReference } from "../../interfaces/generated/aws-personalize-interfaces.generated";
/**
 ...
 */
export declare class CfnDatasetGroup extends cdk.CfnResource implements cdk.IInspectable, IDatasetGroupRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnSchema extends cdk.CfnResource implements cdk.IInspectable, ISchemaRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnSolution extends cdk.CfnResource implements cdk.IInspectable, ISolutionRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
 ...
 */
export declare class CfnEventTracker extends cdk.CfnResource implements cdk.IInspectable, IEventTrackerRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnEventTracker from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnEventTracker;
    /**
     * Checks whether the given object is a CfnEventTracker
     */
    static isCfnEventTracker(x: any): x is CfnEventTracker;
    static arnForEventTracker(resource: IEventTrackerRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnEventTrackerProps);
    get eventTrackerRef(): EventTrackerReference;
    /**
     * The Amazon Resource Name (ARN) of the dataset group that receives the event data.
     */
    get datasetGroupArn(): string;
     ...
     */
    get attrEventTrackerArn(): string;
    /**
     * The ID of the event tracker. Include this ID in requests to the PutEvents API.
     *
     * @cloudformationAttribute TrackingId
     */
    get attrTrackingId(): string;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-personalize-eventtracker.html
 */
export interface CfnEventTrackerProps {
    /**
     * The Amazon Resource Name (ARN) of the dataset group that receives the event data.
     *
 ...
 */
export declare class CfnMetricAttribution extends cdk.CfnResource implements cdk.IInspectable, IMetricAttributionRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnMetricAttribution from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnMetricAttribution;
    /**
     * Checks whether the given object is a CfnMetricAttribution
     */
    static isCfnMetricAttribution(x: any): x is CfnMetricAttribution;
    static arnForMetricAttribution(resource: IMetricAttributionRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnMetricAttributionProps);
    get metricAttributionRef(): MetricAttributionReference;
    /**
     * The ARN of the destination dataset group.
     */
    get datasetGroupArn(): string;
     ...
     * A list of metric attributes for the metric attribution.
     */
    get metrics(): Array<cdk.IResolvable | CfnMetricAttribution.MetricAttributeProperty> | cdk.IResolvable;
    /**
     * A list of metric attributes for the metric attribution.
     */
    set metrics(value: Array<cdk.IResolvable | CfnMetricAttribution.MetricAttributeProperty> | cdk.IResolvable);
    /**
     * The output configuration details for the metric attribution.
     */
    get metricsOutputConfig(): cdk.IResolvable | CfnMetricAttribution.MetricsOutputConfigProperty;
    /**
     * The output configuration details for the metric attribution.
     */
    set metricsOutputConfig(value: cdk.IResolvable | CfnMetricAttribution.MetricsOutputConfigProperty);
    /**
     * The name of the metric attribution.
     */
    get name(): string;
     ...
     */
    get attrMetricAttributionArn(): string;
    /**
...
export declare namespace CfnMetricAttribution {
    /**
    ...
    interface MetricsOutputConfigProperty {
         ...
         */
        readonly s3DataDestination?: cdk.IResolvable | CfnMetricAttribution.S3DataDestinationProperty;
    }
    /**
     * The configuration details of an Amazon S3 output bucket.
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-personalize-metricattribution.html
 */
export interface CfnMetricAttributionProps {
    /**
     * The ARN of the destination dataset group.
     *
     ...
     */
    readonly metrics: Array<cdk.IResolvable | CfnMetricAttribution.MetricAttributeProperty> | cdk.IResolvable;
    /**
     * The output configuration details for the metric attribution.
     *
     ...
     */
    readonly metricsOutputConfig: cdk.IResolvable | CfnMetricAttribution.MetricsOutputConfigProperty;
    /**
     * The name of the metric attribution.
     *
...
export type { IEventTrackerRef, EventTrackerReference };
export type { IMetricAttributionRef, MetricAttributionReference };
