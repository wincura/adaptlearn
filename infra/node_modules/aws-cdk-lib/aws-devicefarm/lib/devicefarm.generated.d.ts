...
import { DevicePoolReference, IDevicePoolRef, IInstanceProfileRef, INetworkProfileRef, InstanceProfileReference, IProjectRef, ITestGridProjectRef, IUploadRef, IVPCEConfigurationRef, NetworkProfileReference, ProjectReference, TestGridProjectReference, UploadReference, VPCEConfigurationReference } from "../../interfaces/generated/aws-devicefarm-interfaces.generated";
/**
 ...
 */
export declare class CfnUpload extends cdk.CfnResource implements cdk.IInspectable, IUploadRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnUpload from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnUpload;
    /**
     * Checks whether the given object is a CfnUpload
     */
    static isCfnUpload(x: any): x is CfnUpload;
    static arnForUpload(resource: IUploadRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnUploadProps);
    get uploadRef(): UploadReference;
    /**
     * The upload's content type (for example, application/octet-stream).
     */
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-devicefarm-upload.html
 */
export interface CfnUploadProps {
    /**
     * The upload's content type (for example, application/octet-stream).
     *
...
export type { IUploadRef, UploadReference };
