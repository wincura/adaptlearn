...
import { AnalyzerReference, ArchiveRuleReference, IAnalyzerRef, IArchiveRuleRef } from "../../interfaces/generated/aws-accessanalyzer-interfaces.generated";
/**
 ...
 */
export declare class CfnArchiveRule extends cdk.CfnResource implements cdk.IInspectable, IArchiveRuleRef {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnArchiveRule from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnArchiveRule;
    /**
     * Checks whether the given object is a CfnArchiveRule
     */
    static isCfnArchiveRule(x: any): x is CfnArchiveRule;
    static arnForArchiveRule(resource: IArchiveRuleRef): string;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnArchiveRuleProps);
    get archiveRuleRef(): ArchiveRuleReference;
    /**
     * The name of the analyzer for the archive rule.
     */
     ...
     * The criteria for the archive rule.
     */
    get filter(): cdk.IResolvable | Record<string, CfnArchiveRule.FilterItemsProperty | cdk.IResolvable>;
    /**
     * The criteria for the archive rule.
     */
    set filter(value: cdk.IResolvable | Record<string, CfnArchiveRule.FilterItemsProperty | cdk.IResolvable>);
    /**
     * The name of the archive rule.
     */
    get ruleName(): string;
...
export declare namespace CfnArchiveRule {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-accessanalyzer-archiverule.html
 */
export interface CfnArchiveRuleProps {
    /**
     * The name of the analyzer for the archive rule.
     *
     ...
     */
    readonly filter: cdk.IResolvable | Record<string, CfnArchiveRule.FilterItemsProperty | cdk.IResolvable>;
    /**
     * The name of the archive rule.
     *
...
export type { IArchiveRuleRef, ArchiveRuleReference };
