...
export interface SecretRotationApplicationOptions {
     ...
     */
    readonly additionalSemanticVersions?: {
...
export declare class SecretRotationApplication {
     ...
     */
    static readonly DB2_ROTATION_SINGLE_USER: SecretRotationApplication;
    /**
     * Conducts an AWS SecretsManager secret rotation for RDS Db2 using the multi user rotation scheme
     */
    static readonly DB2_ROTATION_MULTI_USER: SecretRotationApplication;
    /**
     * Whether the rotation application uses the multi user scheme
     */
    readonly isMultiUser?: boolean;
     ...
     */
    private readonly partitionalSemanticVersions;
    /**
