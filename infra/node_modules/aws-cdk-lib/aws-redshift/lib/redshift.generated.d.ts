 ...
 */
export declare class CfnSnapshotSchedule extends cdk.CfnResource implements cdk.IInspectable, ISnapshotScheduleRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnSnapshotSchedule from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnSnapshotSchedule;
    /**
     * Checks whether the given object is a CfnSnapshotSchedule
     */
    static isCfnSnapshotSchedule(x: any): x is CfnSnapshotSchedule;
    static arnForSnapshotSchedule(resource: ISnapshotScheduleRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnSnapshotScheduleProps);
    get snapshotScheduleRef(): SnapshotScheduleReference;
    /**
     * The definition of the snapshot schedule.
     */
    get scheduleDefinitions(): Array<string>;
    /**
     * The definition of the snapshot schedule.
     */
    set scheduleDefinitions(value: Array<string>);
    /**
     * The description of the snapshot schedule.
     */
    get scheduleDescription(): string | undefined;
    /**
     * The description of the snapshot schedule.
     */
    set scheduleDescription(value: string | undefined);
    /**
     * A unique identifier for the snapshot schedule.
     */
     ...
     */
    get attrAssociatedClusterCount(): number;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-redshift-snapshotschedule.html
 */
export interface CfnSnapshotScheduleProps {
    /**
     * The definition of the snapshot schedule.
     *
     ...
     */
    readonly scheduleDefinitions: Array<string>;
    /**
     * The description of the snapshot schedule.
     *
...
export type { ISnapshotScheduleRef, SnapshotScheduleReference };
