 ...
 */
export declare class CfnHostKey extends cdk.CfnResource implements cdk.IInspectable, IHostKeyRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnHostKey from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnHostKey;
    /**
     * Checks whether the given object is a CfnHostKey
     */
    static isCfnHostKey(x: any): x is CfnHostKey;
    static arnForHostKey(resource: IHostKeyRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnHostKeyProps);
    get hostKeyRef(): HostKeyReference;
    /**
     * The text description for this host key.
     */
    get description(): string | undefined;
     ...
     * The private key portion of an SSH key pair.
     */
    get hostKeyBody(): string | undefined;
    /**
     * The private key portion of an SSH key pair.
     */
    set hostKeyBody(value: string | undefined);
    /**
     * The identifier of the server that contains the host key.
     */
    get serverId(): string;
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-transfer-hostkey.html
 */
export interface CfnHostKeyProps {
    /**
     * The text description for this host key.
     *
...
export type { IHostKeyRef, HostKeyReference };
