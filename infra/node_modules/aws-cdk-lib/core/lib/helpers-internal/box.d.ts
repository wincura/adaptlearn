...
declare abstract class BaseReadableBox<A> implements IReadableBox<A> {
    ...
    resolve(_: IResolveContext): MakeReadonly<A> | undefined;
}
export declare abstract class ReadonlyState<A> extends BaseReadableBox<A> {
    protected value: A;
    ...
    getMutable(): A;
    getStackTraces(): Array<StackTrace>;
    getOrderedStackTraces(): Array<OrderedStackTrace>;
}
export {};
