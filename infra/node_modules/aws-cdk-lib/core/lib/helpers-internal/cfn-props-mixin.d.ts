...
type CfnWritableProps<T extends CfnResource> = {
    [K in keyof T as K extends keyof CfnResource ? never : T[K] extends Function ? never : K extends `attr${string}` ? never : K extends 'cdkTagManager' ? never : K]: T[K];
};
/**
 ...
 * ```
 */
export declare class CfnPropsMixin<T extends CfnResource> implements IMixin {
    /**
     ...
     */
    static of<T extends CfnResource = never>(cfnResourceTypeName: string, props: DeepPartial<CfnWritableProps<T>>, options?: CfnPropsMixinOptions): CfnPropsMixin<T>;
    private readonly cfnResourceType;
    private readonly props;
    private readonly propertyKeys;
    private readonly strategy;
    constructor(resourceClass: (abstract new (...args: any[]) => T) & {
        readonly CFN_RESOURCE_TYPE_NAME: string;
    }, props: DeepPartial<CfnWritableProps<T>>, options?: CfnPropsMixinOptions);
