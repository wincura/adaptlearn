...
export declare class Stack extends Construct implements ITaggable {
     ...
     * @internal
     */
    _addStackDependency(target: Stack, reason: StackDependencyReason): void;
    /**
     ...
     * @internal
     */
    _removeStackDependency(target: Stack, reason: Omit<StackDependencyReason, 'reason'>): void;
    /**
     ...
     * @internal
     */
    _stackDependenciesCausedBy(source: IConstruct): IConstruct[];
    /**
