 ...
 */
export declare class CfnChangeSet extends cdk.CfnResource implements cdk.IInspectable, IChangeSetRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnChangeSet from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnChangeSet;
    /**
     * Checks whether the given object is a CfnChangeSet
     */
    static isCfnChangeSet(x: any): x is CfnChangeSet;
    /**
     ...
     */
    private _changeSetName;
    /**
     * The type of change set operation.
     */
    private _changeSetType?;
    /**
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnChangeSetProps);
    get changeSetRef(): ChangeSetReference;
    /**
     * The capabilities that are allowed in the stack.
     */
    get capabilities(): Array<string> | undefined;
     ...
     * The name of the change set.
     */
    get changeSetName(): string;
    /**
     * The name of the change set.
     */
    set changeSetName(value: string);
    /**
     * The type of change set operation.
     */
    get changeSetType(): string | undefined;
    /**
     * The type of change set operation.
     */
    set changeSetType(value: string | undefined);
    /**
     * Determines how CloudFormation handles configuration drift during deployment.
     */
     ...
     * Indicates if the change set imports resources that already exist.
     */
    get importExistingResources(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates if the change set imports resources that already exist.
     */
    set importExistingResources(value: boolean | cdk.IResolvable | undefined);
    /**
     * Creates a change set for all nested stacks specified in the template.
     */
    get includeNestedStacks(): boolean | cdk.IResolvable | undefined;
    /**
     * Creates a change set for all nested stacks specified in the template.
     */
    set includeNestedStacks(value: boolean | cdk.IResolvable | undefined);
    /**
     * The ARNs of Amazon SNS topics that CloudFormation associates with the stack.
     */
    get notificationArns(): Array<string> | undefined;
     ...
     * Determines what action will be taken if stack creation fails.
     */
    get onStackFailure(): string | undefined;
    /**
     * Determines what action will be taken if stack creation fails.
     */
    set onStackFailure(value: string | undefined);
    /**
     * The ARN of an IAM role that CloudFormation assumes when executing the change set.
     */
     ...
     * Key-value pairs to associate with the change set.
     */
    get tags(): Array<CfnChangeSet.TagsItemsProperty> | undefined;
    /**
     * Key-value pairs to associate with the change set.
     */
    set tags(value: Array<CfnChangeSet.TagsItemsProperty> | undefined);
    /**
     * A structure that contains the body of the revised template.
     */
    get templateBody(): string | undefined;
     ...
     * Whether to reuse the template associated with the stack to create the change set.
     */
    get usePreviousTemplate(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether to reuse the template associated with the stack to create the change set.
     */
    set usePreviousTemplate(value: boolean | cdk.IResolvable | undefined);
    /**
...
export declare namespace CfnChangeSet {
    /**
     * @struct
     * @stability external
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-cloudformation-changeset.html
 */
export interface CfnChangeSetProps {
    /**
     * The capabilities that are allowed in the stack.
     *
     ...
     */
    readonly importExistingResources?: boolean | cdk.IResolvable;
    /**
     * Creates a change set for all nested stacks specified in the template.
     *
     ...
     */
    readonly includeNestedStacks?: boolean | cdk.IResolvable;
    /**
     * The ARNs of Amazon SNS topics that CloudFormation associates with the stack.
     *
     ...
     */
    readonly tags?: Array<CfnChangeSet.TagsItemsProperty>;
    /**
     * A structure that contains the body of the revised template.
     *
     ...
     */
    readonly usePreviousTemplate?: boolean | cdk.IResolvable;
}
/**
...
export type { IChangeSetRef, ChangeSetReference };
