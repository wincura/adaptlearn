...
import { CollectionReference, DatasetReference, ICollectionRef, IDatasetRef, IProjectRef, IStreamProcessorRef, ProjectReference, StreamProcessorReference } from "../../interfaces/generated/aws-rekognition-interfaces.generated";
/**
...
export declare class CfnDataset extends cdk.CfnResource implements cdk.IInspectable, IDatasetRef, cdk.ITaggableV2 {
     ...
     * The ARN of the project to which the dataset belongs.
     */
    get projectArn(): string | undefined;
    /**
     * The ARN of the project to which the dataset belongs.
     */
    set projectArn(value: string | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
